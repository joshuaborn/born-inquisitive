...
PROC FORMAT LIBRARY=NSFG.MaleFormats_2017_2019 CNTLOUT=NSFG.MaleFormats_2017_2019;
   value Y1N5C
      1 = 'Yes'  
      5 = 'No' ;
   value AGESCRN
...
DATA NSFG.MaleData_2017_2019;
INFILE "/home/u43676684/NSFG/Data/2017_2019_MaleData.dat" LRECL=4088;
INPUT
...
PROC SQL NOPRINT;
    CREATE TABLE NSFG.MaleLabels_2017_2019 AS
    SELECT *
    FROM dictionary.columns
    WHERE libname="NSFG" AND UPCASE(memname)="MALEDATA_2017_2019";
QUIT;
