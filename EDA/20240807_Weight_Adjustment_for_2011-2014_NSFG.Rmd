...
data_preg <- bind_rows(
  ...
  mutate(
    ...
    gestational_age = case_when(
      PRGLNGTH %in% 0:13 ~ '1st trimester (13 or less weeks)',
      PRGLNGTH %in% 14:95 ~ '2nd or 3rd trimester (14 or more weeks)'
    ),
    birth = if_else(
      OUTCOME == 'LIVE BIRTH',
      1,
...
CDC_2010 <- bind_rows(
  ...
  tribble(
    ~Level, ~PctCDC,
    '1st trimester (13 or less weeks)',       92.0,
    '2nd or 3rd trimester (14 or more weeks)', 8.0
  ) |>  mutate(
...
CDC_2008 <- bind_rows(
  ...
  tribble(
    ~Level, ~PctCDC,
    '1st trimester (13 or less weeks)',       91.5,
