    ...
    data_preg |>
      ...
      summarize(
        abortion_2006_2010_age = case_when(
          ...
          any(OUTCOME == 'INDUCED ABORTION' & Year %in% 2006:2010 & AgeAtEndOfPregnancy >= 40) ~ '40 years and over',
          .default = 'Other'
        ),
        abortion_2006plus_age = case_when(
          ...
          any(OUTCOME == 'INDUCED ABORTION' & Year > 2006 & AgeAtEndOfPregnancy >= 40) ~ '40 years and over',
          .default = 'Other'
        ),
        ...
        birth_2006_age = case_when(
          ...
          any(OUTCOME == 'LIVE BIRTH' & Year == 2006 & AgeAtEndOfPregnancy >= 40) ~ '40 years and over',
          .default = 'Other'
        ),
        birth_2007_age =  case_when(
          ...
          any(OUTCOME == 'LIVE BIRTH' & Year == 2007 & AgeAtEndOfPregnancy >= 40) ~ '40 years and over',
          .default = 'Other'
        ),
        birth_2008_age =  case_when(
          ...
          any(OUTCOME == 'LIVE BIRTH' & Year == 2008 & AgeAtEndOfPregnancy >= 40) ~ '40 years and over',
          .default = 'Other'
        ),
        birth_2009_age =  case_when(
          ...
          any(OUTCOME == 'LIVE BIRTH' & Year == 2009 & AgeAtEndOfPregnancy >= 40) ~ '40 years and over',
          .default = 'Other'
        ),
        birth_2010_age =  case_when(
          ...
          any(OUTCOME == 'LIVE BIRTH' & Year == 2010 & AgeAtEndOfPregnancy >= 40) ~ '40 years and over',
          .default = 'Other'
        )
      ),
    by = 'CASEID'
