...
```{r check-2019-date, dependson="process-charagegroups-data-2019"}
tidy_results2019 |>
...
```{r check-2019-age, dependson="process-charagegroups-data-2019"}
tidy_results2019 |>
...
```{r check-2019-hisp, dependson="process-charagegroups-data-2019"}
tidy_results2019 |>
...
```{r check-2019-race, dependson="process-charagegroups-data-2019"}
tidy_results2019 |>
...
```{r check-2019-sex, dependson="process-charagegroups-data-2019"}
tidy_results2019 |>
  group_by(SEX, SEX_f) |>
  count() |>
  kable()
...
```{r check-2019-universe, dependson="process-charagegroups-data-2019"}
tidy_results2019 |>
  group_by(UNIVERSE) |>
  count() |>
  kable()
...
race_ethn2019 |>
  ...
  select(UNIVERSE, SEX_f, race_ethn, AGEGROUP_f, POP) |>
  gt() |>
  fmt_number(
    POP,
    decimals = 0
...
processed_07_18 |>
  filter(UNIVERSE == "Household population" & as.integer(SEX_f) > 1) |>
  gt() |>
  fmt_number(
    pop,
    decimals = 0
