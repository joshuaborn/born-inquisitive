...
NSFG_2015_2019_for_calibration |>
  count(abortions_in_2014) |>
  gt()

NSFG_2015_2019_for_calibration |>
  count(abortions_in_2013) |>
  gt()
```
...
```{r verify-post-stratification, dependson=c("create-NSFG-survey-objects", "create-calibrated-NSFG-survey-objects")}
...
NSFG_2015_2019_fem_svy |>
  ...
  select(Year, Uncal, Calib, Diff, Freq, Calib_low, Calib_upp, Calib_Rel_Bias) |>
  gt() |>
  fmt_number(where(is.numeric), n_sigfig = 4, suffix = 'k') |>
  fmt_percent(Calib_Rel_Bias, decimals = 1)
```
