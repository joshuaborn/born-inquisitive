...
NSFG_data_preg2015_2019 <- bind_rows(
  select(NSFG_raw_preg2015_2017, SECU, SEST, CASEID, DATEND, OUTCOME, AGEPREG, NBRNLV_S),
  select(NSFG_raw_preg2017_2019, SECU, SEST, CASEID, DATEND, OUTCOME, AGEPREG, NBRNLV_S)
) |>
left_join(
