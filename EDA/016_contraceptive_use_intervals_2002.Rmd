...
* "None" values are encoded as a kind of method, sometimes.
    ...
    * When all methods are used in together and there are 3 or more methods, either `METHUSIMX_51` has a value of 1 or the entire second cluster variables are blank, i.e., `NA` values.
...
cal2002bool <- copy(cal2002[, .(CASEID, cm_value, cm_label, NUMMULT)])
