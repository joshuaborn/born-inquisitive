...
```{r prioritization-exploration, dependson='boolean-table'}
```
...
```{r sequential-exploration-1, dependson='boolean-table', eval=FALSE}
cal2002[CASEID %in% cal2002[is.na(SIMSEQ) & NUMMULT == 2, CASEID]] |> kable()
```
...
```{r sequential-exploration-2, dependson='boolean-table', eval=FALSE}
...
```{r sequential-exploration-3, dependson='boolean-table'}
