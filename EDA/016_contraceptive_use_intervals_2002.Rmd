...
Women-months in which there are 0, 1, or 2 contraceptive methods used account for over 99\% of woman-months in the contraceptive use calendar, and handling these cases are much simpler than the cases in which there are 3 or more methods mentioned. Therefore, I'll proceed by breaking up just the woman-months with less than 3 methods first and count the number of contraceptive use intervals by method before looping back.

* Reread "Appendix: Segment Data" and similar sections in previous papers, as needed
* Make initial pass at counting segments
* Include pregnancy information in counting segments
* Include 3 or more method woman-months in counting segments
* Include marital status change in counting segments
