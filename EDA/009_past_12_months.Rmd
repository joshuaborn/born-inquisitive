...
collect_estimate(
  ...
  type = 'total',
  domain = 'males who used at least one method of contraception in the past 12 months with their wife or cohabitating partner and who are not surgically sterile',
  title = 'by how frequently any contraceptive was used in past 12 months'
) |> kable()
```
...
collect_estimate(
  ...
  type = 'total',
  domain = 'males who used at least one method of contraception in the past 12 months their last partner and who are not surgically sterile',
  title = 'by how frequently any contraceptive was used in past 12 months'
) |> kable()
```
