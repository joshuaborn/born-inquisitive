...
fem_2017_2019_data <- copy(fem_2017_2019$Data[, .(
  ...
  PST4WKSX,# = factorize(PST4WKSX, 'PSTWKSF', fem_2017_2019_formats),
...
It may be simply the case that the 5 respondents who have `NA` values for `PST4WKSX` may not have had intercourse with a male in the 4 weeks before the interview, but it's not clear from the codebook.
...
collect_estimate(
  ...
  type = 'total',
  domain = 'females who had intercourse with a male at least once in the past 3 months',
...
collect_estimate(
  ...
  type = 'total',
  domain = 'females who had intercourse with a male at least once in the past 4 weeks and used the pill either the previous or current month',
