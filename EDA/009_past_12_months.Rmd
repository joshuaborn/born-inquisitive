...
fem_2017_2019_METHX_indices <- c(2:13, 19:21, 25:26)
...
# count any respondents who are sexually active within past 3 months and whose last intercourse was with husband or cohabitating partner who has an active vasectomy as using vasectomy as a contraceptive method
...
For females, a pivot table needs to be created with the `METHX` series of variables, the `CMMHCCALX` series of variables, the `CASEID` variable, and the `CMINTVW` variable.
