...
est2015_2019 <- bind_rows(
  ...
  mutate(
    Data.Vintage = '2015-2019',
    Covers.Births = Births_low < Total.Births & Total.Births < Births_upp,
    Covers.Abortions = Abortions_low < Total.Abortions & Total.Abortions < Abortions_upp
  ) |>
  arrange(Year) |>
  rename(
    'Births.Low' = Births_low,
    'Births.Est' = Births,
    'Births.High' = Births_upp,
    'Abortions.Low' = Abortions_low,
    'Abortions.Est' = Abortions,
    'Abortions.High' = Abortions_upp,
    'Births.Total' = Total.Births,
    'Abortions.Total' = Total.Abortions
  ) |>
  select(
    Data.Vintage, Year,
    Births.Low, Births.Est, Births.High, Births.Total, Covers.Births,
    Abortions.Low, Abortions.Est, Abortions.High, Abortions.Total, Covers.Abortions
  )
```
