...
```{r table-from-2015-2019-NSFG, dependson="estimate-based-on-2015-2019-NSFG", include=FALSE}
gt(est2015_2019) |>
  fmt_number(
...
```{r define-plot-function, dependson="estimate-based-on-2015-2019-NSFG"}
...
```{r plot-births-from-2015-2019-NSFG, dependson="define-plot-function"}
plot_CIs_against_census_counts(
  filter(est2015_2019, Type == 'Births'),
  2015,
  2019,
  'Live Births'
)
...
```{r plot-abortions-from-2015-2019-NSFG, dependson="define-plot-function"}
plot_CIs_against_census_counts(
  filter(est2015_2019, Type == 'Abortions'),
  2015,
  2019,
  'Induced Abortions'
)
