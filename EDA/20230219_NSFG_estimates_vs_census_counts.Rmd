...
nsfg2011_2013 <- select(preg2011_2013, SECU, SEST, CASEID, DATEND, OUTCOME, WGT2011_2013) |>
  mutate(
    DATEND = as.numeric(DATEND) + 3653,
    Year = cm_to_year(DATEND),
    OUTCOME = labelled(OUTCOME, c(
...
nsfg2013_2015 <- select(preg2013_2015, SECU, SEST, CASEID, DATEND, OUTCOME, WGT2013_2015) |>
  mutate(
    Year = cm_to_year(DATEND),
    OUTCOME = labelled(OUTCOME, c(
      "LIVE BIRTH" = 1,
...
nsfg2015_2017 <- select(preg2015_2017, SECU, SEST, CASEID, DATEND, OUTCOME, WGT2015_2017) |>
  mutate(
    Year = DATEND,
    OUTCOME = labelled(OUTCOME, c(
      "LIVE BIRTH" = 1,
...
nsfg2017_2019 <- select(preg2017_2019, SECU, SEST, CASEID, DATEND, OUTCOME, WGT2017_2019) |>
  mutate(
    Year = DATEND,
    OUTCOME = labelled(OUTCOME, c(
      "LIVE BIRTH" = 1,
...
estimates <- bind_rows(
  ...
  estimate_births_and_abortions(nsfg2011_2013, 2011, 2013, census_counts),
  estimate_births_and_abortions(nsfg2013_2015, 2013, 2015, census_counts),
  estimate_births_and_abortions(nsfg2015_2017, 2015, 2017, census_counts),
  estimate_births_and_abortions(nsfg2017_2019, 2017, 2019, census_counts)
)
```
