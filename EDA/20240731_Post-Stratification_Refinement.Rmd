...
```{r create-post-stratified-pregnancies-survey, dependson="create-jackknife-female-survey"}
post_preg <- data_preg |>
  select(-WGT2015_2019) |>
  left_join(
    post_fem |>
...
* Reduce variance introduced by post-stratification.
  ...
  * Reduce number of levels for age.
  * Limit time frame for abortions making respondent eligible for adjustment post-strata.
  * Reverse precedent of level assignment in adjustment post-strata.
