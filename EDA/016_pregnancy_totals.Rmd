...
Rather than using [CDC WONDER](https://wonder.cdc.gov/) or the [public use microdata files for births](https://www.cdc.gov/nchs/data_access/vitalstatsonline.htm), [this visualization] had the total live birth counts from 1909 to 2020 downloadable as a CSV. Once I get into subdomains, I will have to look for other ways to get counts, either via the microdata or be going through tables in published NCHS reports.
