---
title: "NSFG Cycle 4 (1988) Weight Adjustment"
author: "Joshua Born"
output:
  html_document:
    code_folding: hide
...
data_fem <- select(
  ...
  mutate(
    ...
    # Define the variables that will create the post-stratification dimensions here
    demographic_category_collapsed,
    age_coarse,
    age_granular,
    marital_status,
    parity2,
    ...
    # age_coarse x parity5
    # age_coarse x marital_status
    # age_granular x demographic_category
    # age_granular x parity2
    # age_granular x marital_status
    # age_granular x demographic_category x parity2
    # age_granular x demographic_category x parity3
    # age_granular x demographic_category_collapsed x parity4
    # age_granular x demographic_category_collapsed x parity5
    # age_granular x demographic_category x marital_status
    # age_granular x demographic_category_collapsed x marital_status
  ) |>
  left_join(
    data_preg |>
      group_by(SEQNUM) |>
...
births_estimates_before <- before_preg |>
  filter(
...
births_estimates_after <-  after_preg |>
  filter(
    Year %in% 1995:2001 & OUTCOME == 'LIVE BIRTH'
  ) |>
  group_by(Year, OUTCOME, age_group6) |>
