...
There are cases in the universe for `YNOSEX` as specified in the codebook does not have an answer for `YNOSEX`. However, all of the cases with answers to `YNOSEX` are in the universe for `YNOSEX` specified in the codebook.
