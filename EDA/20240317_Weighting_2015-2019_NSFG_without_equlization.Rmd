---
title: "Weight Adjustment of 2015-2019 NSFG with equalization of weight sums after adjustment turned off"
author: "Joshua Born"
output:
  html_document:
    code_folding: hide
...
NVSS_births_2011_2014 <- read_tsv(
  ...
  mutate(
    ...
    No = poststrat_pop_total - Yes
  ) |>
  select(variable_name, Yes, No) |>
  pivot_longer(c(Yes, No), values_to = 'Freq')

poststrat_births_targets <- NVSS_births_2011_2014 |>
  pull(variable_name) |>
  unique() |>
...
poststrat_targets <- c(list(poststrat_pop_targets), poststrat_births_targets)
