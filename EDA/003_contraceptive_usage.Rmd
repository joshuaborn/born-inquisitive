...
female_currently_totals <- svybyci(~count, ~currently, fem_svy, svytotal)
...
female_currently_totals2 <- svybyci(~count, ~currently2, fem_svy, svytotal)
...
female_number_current_methods_totals <- svybyci(~count, ~current_contraceptive_count_factor, female_current_contraceptors, svytotal)
...
female_current_exclusive_method_totals <- svybyci(~count, ~METH3M1_factor, female_current_exclusive, svytotal)
...
female_current_pair_totals <- svybyci(~count, ~meth3m_pair_factor, female_current_pair, svytotal)
...
female_current_calendar_estimates <- rbind(
  female_current_calendar_estimates,
  female_exclusive_calendar_estimate
)

female_current_calendar_estimates[, 2:5] <- female_current_calendar_estimates[, 2:5] / 10^6
