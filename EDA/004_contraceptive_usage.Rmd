...
```{r, dependson=c('fem-process-data')}
fem_2017_2019_data[
  meth3m_count == 0 & SEX3MO == 'YES' & as.integer(FECUND) == 1,
  .(
    CASEID,
    DATFEMOP_Y,
    DATFEMOP_Y2,
...
```{r, dependson=c('fem-process-data')}
fem_2017_2019_data[
  meth3m_count == 0 & SEX3MO == 'YES' & as.integer(FECUND) == 1 & STRLOPER == 'TUBAL LIGATION OR STERILIZATION',
  .(
    CASEID,
    DATFEMOP_Y,
    FMEDREAS1,
...
```{r, dependson=c('fem-process-data')}
fem_2017_2019_data[
  meth3m_count == 0 & SEX3MO == 'YES' & STRLOPER == 'HYSTERECTOMY',
  .(
    CASEID,
    DATFEMOP_Y2,
    FMEDREAS7,
...
```{r, dependson=c('fem-process-data')}
fem_2017_2019_data[
  meth3m_count == 0 & SEX3MO == 'YES' & STRLOPER == 'OTHER OPERATION OR TYPE UNKNOWN',
  .(
    CASEID,
    DATFEMOP_Y4,
    FMEDREAS19,
...
* Include all non-reversed tubal ligations as current contraception usage
