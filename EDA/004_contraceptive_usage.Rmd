...
I am willing to count just those with either `WYNOLSTP` or `WYNOTUSE` of "Yes" as currently trying to conceive. Those who failed to answer the completely and so were not asked the `WYNOLSTP` or `WYNOTUSE` questions, but are trying to conceive will not be counted.

The larger issue is that the inconsistency between `CURRMETH` and `MTHUSE3` and the `METH3M` series needs to resolved.



## To Do

* Fix inconsistency of `CURRMETH` vs `MTHUSE3` and `METH3M`
