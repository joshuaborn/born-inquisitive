...
# count any respondents with current tubal ligations as currently using the corresponding contraceptive method
...
However, this is unsound for female respondent's who are married or cohabitating and whose partners have vasectomies, because there is the possibility of sexual intercourse with someone not the reported partner.
...
This case is very rare, and by the same reasoning as not counting vasectomies not reported as contraceptive use, females could be having intercourse with someone other than their identified partners. If either of these cases are to be counted separately, care should be taken to check whether respondent's last intercourse was with identified husband / cohabiting partner.
