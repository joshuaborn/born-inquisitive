...
collect_estimate(
  ...
  title = 'trying to get pregnant, had sexual intercourse with male in previous 3 months, not currently pregnant, fertile, and not in a sexual relationship with an infertile male',
  type = 'total',
  domain = 'females not currently using contraception'
) |> kable()
```
...
* Rewrite titles for those not using contraception estimates thus far
