...
```{r, dependson=c('fem-process-data')}
fem_2017_2019_data[, tablena(MTHUSE3)]

fem_2017_2019_data[, tablena(SEX3MO)]

fem_2017_2019_data[, tablena(HADSEX)]

fem_2017_2019_data[MTHUSE3 == 'Not Applicable (NA)', .N] ==
...
collect_estimate(
  svyci(
    ...
    subset(fem_2017_2019_svy, as.integer(MTHUSE3) != 1),
    svytotal
  ),
