---
title: "NSFG 2006-2010 Weight Adjustment"
author: "Joshua Born"
output:
  html_document:
    code_folding: hide
...
```{r load-raw-data}
raw_preg_2006_2010 <- read_sas(
  data_file = here('data/NSFG/d2006_2010fempreg.sas7bdat'),
  catalog_file = here('data/NSFG/d2006_2010fempreg.sas7bcat')
)
raw_fem_2006_2010 <- read_sas(
  data_file = here('data/NSFG/d2006_2010femresp.sas7bdat'),
  catalog_file = here('data/NSFG/d2006_2010femresp.sas7bcat')
)
```
...
data_fem <- select(
  ...
  left_join(
    data_preg |>
      group_by(CASEID) |>
      summarize(
        abortion_2002_2005_age = case_when(
          any(OUTCOME == 'INDUCED ABORTION' & Year %in% 2002:2005 & AgeAtEndOfPregnancy < 20) ~ 'Under 20 years',
          any(OUTCOME == 'INDUCED ABORTION' & Year %in% 2002:2005 & AgeAtEndOfPregnancy <= 24) ~ '20-24 years',
          any(OUTCOME == 'INDUCED ABORTION' & Year %in% 2002:2005 & AgeAtEndOfPregnancy <= 29) ~ '25-29 years',
          any(OUTCOME == 'INDUCED ABORTION' & Year %in% 2002:2005 & AgeAtEndOfPregnancy <= 34) ~ '30-34 years',
          any(OUTCOME == 'INDUCED ABORTION' & Year %in% 2002:2005 & AgeAtEndOfPregnancy >= 35) ~ '35 years and over',
          .default = 'Other'
        ),
        abortion_2002plus_age = case_when(
          any(OUTCOME == 'INDUCED ABORTION' & Year > 2002 & AgeAtEndOfPregnancy < 20) ~ 'Under 20 years',
          any(OUTCOME == 'INDUCED ABORTION' & Year > 2002 & AgeAtEndOfPregnancy <= 24) ~ '20-24 years',
          any(OUTCOME == 'INDUCED ABORTION' & Year > 2002 & AgeAtEndOfPregnancy <= 29) ~ '25-29 years',
          any(OUTCOME == 'INDUCED ABORTION' & Year > 2002 & AgeAtEndOfPregnancy <= 34) ~ '30-34 years',
          any(OUTCOME == 'INDUCED ABORTION' & Year > 2002 & AgeAtEndOfPregnancy >= 35) ~ '35 years and over',
          .default = 'Other'
        ),
        birth_2003_marital_status =  case_when(
          any(OUTCOME == 'LIVE BIRTH' & Year == 2003 & FMAROUT5 == 'MARRIED') ~ 'Married',
          any(OUTCOME == 'LIVE BIRTH' & Year == 2003) ~ 'Unmarried',
          .default = 'Other'
        ),
        birth_2004_marital_status =  case_when(
          any(OUTCOME == 'LIVE BIRTH' & Year == 2004 & FMAROUT5 == 'MARRIED') ~ 'Married',
          any(OUTCOME == 'LIVE BIRTH' & Year == 2004) ~ 'Unmarried',
          .default = 'Other'
        ),
        birth_2005_marital_status =  case_when(
          any(OUTCOME == 'LIVE BIRTH' & Year == 2005 & FMAROUT5 == 'MARRIED') ~ 'Married',
          any(OUTCOME == 'LIVE BIRTH' & Year == 2005) ~ 'Unmarried',
          .default = 'Other'
        ),
        birth_2002_age = case_when(
          any(OUTCOME == 'LIVE BIRTH' & Year == 2002 & AgeAtEndOfPregnancy < 20) ~ 'Under 20 years',
          any(OUTCOME == 'LIVE BIRTH' & Year == 2002 & AgeAtEndOfPregnancy <= 24) ~ '20-24 years',
          any(OUTCOME == 'LIVE BIRTH' & Year == 2002 & AgeAtEndOfPregnancy <= 29) ~ '25-29 years',
          any(OUTCOME == 'LIVE BIRTH' & Year == 2002 & AgeAtEndOfPregnancy <= 34) ~ '30-34 years',
          any(OUTCOME == 'LIVE BIRTH' & Year == 2002 & AgeAtEndOfPregnancy >= 35) ~ '35 years and over',
          .default = 'Other'
        ),
        birth_2003_age =  case_when(
          any(OUTCOME == 'LIVE BIRTH' & Year == 2003 & AgeAtEndOfPregnancy < 20) ~ 'Under 20 years',
          any(OUTCOME == 'LIVE BIRTH' & Year == 2003 & AgeAtEndOfPregnancy <= 24) ~ '20-24 years',
          any(OUTCOME == 'LIVE BIRTH' & Year == 2003 & AgeAtEndOfPregnancy <= 29) ~ '25-29 years',
          any(OUTCOME == 'LIVE BIRTH' & Year == 2003 & AgeAtEndOfPregnancy <= 34) ~ '30-34 years',
          any(OUTCOME == 'LIVE BIRTH' & Year == 2003 & AgeAtEndOfPregnancy >= 35) ~ '35 years and over',
          .default = 'Other'
        ),
        birth_2004_age =  case_when(
          any(OUTCOME == 'LIVE BIRTH' & Year == 2004 & AgeAtEndOfPregnancy < 20) ~ 'Under 20 years',
          any(OUTCOME == 'LIVE BIRTH' & Year == 2004 & AgeAtEndOfPregnancy <= 24) ~ '20-24 years',
          any(OUTCOME == 'LIVE BIRTH' & Year == 2004 & AgeAtEndOfPregnancy <= 29) ~ '25-29 years',
          any(OUTCOME == 'LIVE BIRTH' & Year == 2004 & AgeAtEndOfPregnancy <= 34) ~ '30-34 years',
          any(OUTCOME == 'LIVE BIRTH' & Year == 2004 & AgeAtEndOfPregnancy >= 35) ~ '35 years and over',
          .default = 'Other'
        ),
        birth_2005_age =  case_when(
          any(OUTCOME == 'LIVE BIRTH' & Year == 2005 & AgeAtEndOfPregnancy < 20) ~ 'Under 20 years',
          any(OUTCOME == 'LIVE BIRTH' & Year == 2005 & AgeAtEndOfPregnancy <= 24) ~ '20-24 years',
          any(OUTCOME == 'LIVE BIRTH' & Year == 2005 & AgeAtEndOfPregnancy <= 29) ~ '25-29 years',
          any(OUTCOME == 'LIVE BIRTH' & Year == 2005 & AgeAtEndOfPregnancy <= 34) ~ '30-34 years',
          any(OUTCOME == 'LIVE BIRTH' & Year == 2005 & AgeAtEndOfPregnancy >= 35) ~ '35 years and over',
          .default = 'Other'
        )
      ),
    by = 'CASEID'
  ...
  mutate(
    ...
    abortion_2002plus_age = if_else(
      abortion_2002plus_age != abortion_2002_2005_age & abortion_2002_2005_age != 'Other',
      abortion_2002_2005_age,
      abortion_2002plus_age
    )
  )
...
guttmacher_APC_age <- guttmacher_APC_national |>
  ...
  mutate(
    ...
    Freq = if_else(
      abortion_2002_2005_age == 'Other',
      population_total - Freq,
      Freq
    )
  ) |>
  arrange(abortion_2002_2005_age) |>
  select(abortion_2002_2005_age, Freq)


NVSS_age <- bind_rows(
  read_tsv(
    here('data/NVSS/2002-2005/age_2002.txt'),
    name_repair = 'universal',
    show_col_types = FALSE
  ) |>
    rename(
      Age.of.Mother.9.Code = Age.of.Mother.Code,
      Age.of.Mother.9 = Age.of.Mother
    ),
  read_tsv(
    here('data/NVSS/2002-2005/age_2003_2005.txt'),
    name_repair = 'universal',
    show_col_types = FALSE
  )
) |>
...
NVSS_marital_status <- read_tsv(
    here('data/NVSS/2002-2005/marital_status_2003_2005.txt'),
    name_repair = 'universal',
    show_col_types = FALSE
  ) |>
...
weight_adj_strata[[9]] <- ~abortion_2002plus_age
...
post_fem |>
  ...
  arrange(CASEID) |>
  saveRDS(here('data/NSFG/adjusted_2006_2010_weights.Rds'))

saveRDS(
  post_fem$rscales,
  here('data/NSFG/adjusted_2006_2010_rscales.Rds')
)
```
...
after_fem <- data_fem |>
  select(-WGTQ1Q16) |>
  left_join(
    readRDS(here('data/NSFG/adjusted_2006_2010_weights.Rds')),
    by = join_by(CASEID)
  ) |>
  as_survey_rep(
    type = 'JKn',
    ...
    rscales = readRDS(here('data/NSFG/adjusted_2006_2010_rscales.Rds'))
  )
...
entropy_extreme_before <- before_fem$variables |>
  select(CASEID, WGTQ1Q16) |>
  filter(
    WGTQ1Q16^2 > 10 * mean(WGTQ1Q16^2)
  )
  ...
  left_join(
    before_fem$variables |>
      select(
        ...
        birth_2003_marital_status,
        birth_2004_marital_status,
        birth_2005_marital_status,
        birth_2002_age,
        birth_2003_age,
        birth_2004_age,
        birth_2005_age
...
iqr_extreme_before <- before_fem$variables |>
  select(CASEID, WGTQ1Q16) |>
  filter(
    WGTQ1Q16 > 5 * IQR(WGTQ1Q16) + median(WGTQ1Q16)
  )
...
after_fem |>
  group_by(birth_2003_marital_status) |>
  summarize(
    Count = n(),
    Est = survey_total(one)
  ) |>
  full_join(
    poststrat_targets[[6]],
    by = join_by(birth_2003_marital_status)
  ) |>
  mutate(
    Diff = Est - Freq
  ) |>
...
after_fem |>
  group_by(birth_2004_marital_status) |>
  summarize(
    Count = n(),
    Est = survey_total(one)
  ) |>
  full_join(
    poststrat_targets[[7]],
    by = join_by(birth_2004_marital_status)
  ) |>
  mutate(
    Diff = Est - Freq
  ) |>
...
after_fem |>
  group_by(birth_2005_marital_status) |>
  summarize(
    Count = n(),
    Est = survey_total(one)
  ) |>
  full_join(
    poststrat_targets[[8]],
    by = join_by(birth_2005_marital_status)
  ) |>
  mutate(
    Diff = Est - Freq
  ) |>
...
after_fem |>
  group_by(abortion_2002_2005_age) |>
  summarize(
    Count = n(),
    Est = survey_total(one)
  ) |>
  full_join(
    poststrat_targets[[9]],
    by = join_by(abortion_2002_2005_age)
  ) |>
  mutate(
    Diff = Est - Freq
  ) |>
...
before_fem |>
  group_by(abortion_2002plus_age) |>
  summarize(
    Count = n(),
    Before = survey_total(one)
  ) |>
  full_join(
    ...
    by = join_by(abortion_2002plus_age)
  ) |>
  mutate(
    Factor = After / Before
  ) |>
...
test_harness_births <- bind_rows(
  ...
  bind_rows(
    read_tsv(
      here('data/NVSS/2002-2005/race_ethnicity_2002.txt'),
      name_repair = 'universal',
      show_col_types = FALSE
    ) |>
      rename(
    ...
    read_tsv(
      here('data/NVSS/2002-2005/race_ethnicity_2003_2005.txt'),
      name_repair = 'universal',
      show_col_types = FALSE
    ) |>
      rename(
...
births_estimates_before <- bind_rows(
  before_preg |>
    filter(
      Year %in% 2002:2005 & OUTCOME == 'LIVE BIRTH'
    ) |>
