...
summarize_weights <- function(x, label) {
  tibble(
    n = sum(!is.na(x)),
    missing = sum(is.na(x)),
    min = min(x),
...
summarize_weights(
  NSFG_2015_2019_fem_svy$variable$WGT2015_2019,
  'original_weights'
)

summarize_weights(
  attr(NSFG_2015_2019_fem_cal_svy$postStrata[[1]][[5]], 'oldweights'),
  'oldweights1_1'
)

summarize_weights(
  attr(NSFG_2015_2019_fem_cal_svy$postStrata[[1]][[1]], 'weights'),
  'weights_1_1'
)

summarize_weights(
  attr(NSFG_2015_2019_fem_cal_svy$postStrata[[1]][[2]], 'weights'),
  'weights_1_2'
)

summarize_weights(
  attr(NSFG_2015_2019_fem_cal_svy$postStrata[[1]][[3]], 'weights'),
  'weights_1_3'
)

summarize_weights(
  attr(NSFG_2015_2019_fem_cal_svy$postStrata[[1]][[4]], 'weights'),
  'weights_1_4'
)

summarize_weights(
  attr(NSFG_2015_2019_fem_cal_svy$postStrata[[1]][[5]], 'weights'),
  'weights_1_5'
)
```
