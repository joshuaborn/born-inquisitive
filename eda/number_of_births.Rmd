...
preg_data_2015_2017 %>%
  ...
  knitr::kable(
    align = 'llrr',
    caption = '**Table 7:** Number of births in thousands during 2010-2018 estimated from NSFG 2015-2017 data, not including births in year earlier than year respondents came to United States.'
  )
```
