---
title: "2011-2015 NSFG Weight Adjustment"
author: "Joshua Born"
output:
  html_document:
    code_folding: hide
...
data_fem <- bind_rows(
  ...
  left_join(
    data_preg |>
      group_by(CASEID) |>
      summarize(
        abortions_2006_2010 = sum(OUTCOME == 'INDUCED ABORTION' & Year %in% 2006:2010),
        abortion_2006_2010_age = case_when(
          ...
          any(OUTCOME == 'INDUCED ABORTION' & Year %in% 2006:2010 & AgeAtEndOfPregnancy <= 39) ~ '35-39 years',
        ...
        abortion_2006plus_age = case_when(
          ...
          any(OUTCOME == 'INDUCED ABORTION' & Year > 2006 & AgeAtEndOfPregnancy <= 39) ~ '35-39 years',
        ...
        birth_2006_age = case_when(
          ...
          any(OUTCOME == 'LIVE BIRTH' & Year == 2006 & AgeAtEndOfPregnancy <= 39) ~ '35-39 years',
        ...
        birth_2007_age =  case_when(
          ...
          any(OUTCOME == 'LIVE BIRTH' & Year == 2007 & AgeAtEndOfPregnancy <= 39) ~ '35-39 years',
        ...
        birth_2008_age =  case_when(
          ...
          any(OUTCOME == 'LIVE BIRTH' & Year == 2008 & AgeAtEndOfPregnancy <= 39) ~ '35-39 years',
        ...
        birth_2009_age =  case_when(
          ...
          any(OUTCOME == 'LIVE BIRTH' & Year == 2009 & AgeAtEndOfPregnancy <= 39) ~ '35-39 years',
        ...
        birth_2010_age =  case_when(
          ...
          any(OUTCOME == 'LIVE BIRTH' & Year == 2010 & AgeAtEndOfPregnancy <= 39) ~ '35-39 years',
  ...
  mutate(
    abortions_2006_2010 = coalesce(abortions_2006_2010, 0),
    abortions_2006_2010_multiplier = if_else(
      abortions_2006_2010 >= 1,
      abortions_2006_2010,
      1
    ),
    across(
...
extras[[1]] <- c(
  ~abortions_2006_2010_multiplier,
  ~abortion_2006plus_age
)
...
after_fem |>
  ...
  summarize(
    Count = n(),
    Est = survey_total(abortions_2006_2010_multiplier)
  ) |>
  full_join(
...
This survey will cover years 2006 to 2010.
