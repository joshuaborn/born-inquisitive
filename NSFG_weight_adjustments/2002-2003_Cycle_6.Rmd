---
title: "Cycle 6 (2002) NSFG Weight Adjustment"
author: "Joshua Born"
output:
  html_document:
    code_folding: hide
    ...
    data_preg |>
      ...
      summarize(
        ...
        abortion_1995_2001_age = case_when(
          ...
          any(OUTCOME == 'INDUCED ABORTION' & Year %in% 1995:2001 & AgeAtEndOfPregnancy <= 39) ~ '35-39 years',
        ...
        abortion_1995plus_age = case_when(
          ...
          any(OUTCOME == 'INDUCED ABORTION' & Year >= 1995 & AgeAtEndOfPregnancy <= 39) ~ '35-39 years',
        ...
        birth_1995_age = case_when(
          ...
          any(OUTCOME == 'LIVE BIRTH' & Year == 1995 & AgeAtEndOfPregnancy <= 39) ~ '35-39 years',
        ...
        birth_1996_age =  case_when(
          ...
          any(OUTCOME == 'LIVE BIRTH' & Year == 1996 & AgeAtEndOfPregnancy <= 39) ~ '35-39 years',
        ...
        birth_1997_age =  case_when(
          ...
          any(OUTCOME == 'LIVE BIRTH' & Year == 1997 & AgeAtEndOfPregnancy <= 39) ~ '35-39 years',
        ...
        birth_1998_age =  case_when(
          ...
          any(OUTCOME == 'LIVE BIRTH' & Year == 1998 & AgeAtEndOfPregnancy <= 39) ~ '35-39 years',
        ...
        birth_1999_age =  case_when(
          ...
          any(OUTCOME == 'LIVE BIRTH' & Year == 1999 & AgeAtEndOfPregnancy <= 39) ~ '35-39 years',
        ...
        birth_2000_age =  case_when(
          ...
          any(OUTCOME == 'LIVE BIRTH' & Year == 2000 & AgeAtEndOfPregnancy <= 39) ~ '35-39 years',
        ...
        birth_2001_age =  case_when(
          ...
          any(OUTCOME == 'LIVE BIRTH' & Year == 2001 & AgeAtEndOfPregnancy <= 39) ~ '35-39 years',
...
NVSS_age <- read_tsv(
  ...
  mutate(
    ...
    Level = factor(
      case_when(
        ...
        Age.of.Mother.Code %in% c('40-44', '45-49', '50+') ~ 'Other',
  ...
  filter(Level != '40 years and over') |>
