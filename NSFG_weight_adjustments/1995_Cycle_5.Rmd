...
data_fem <- select(
  ...
  left_join(
    data_preg |>
      group_by(CASEID) |>
      summarize(
        abortions_1986_1994 = sum(OUTCOME == 'INDUCED ABORTION' & Year %in% 1986:1994),
  ...
  mutate(
    abortions_1986_1994 = coalesce(abortions_1986_1994, 0),
    abortions_1986_1994_multiplier = if_else(
      abortions_1986_1994 >= 1,
      abortions_1986_1994,
      1
    ),
    across(
...
extras[[1]] <- c(
  ~abortions_1986_1994_multiplier,
  ~abortion_1986plus_age
)
...
after_fem |>
  ...
  summarize(
    Count = n(),
    Est = survey_total(abortions_1986_1994_multiplier)
  ) |>
  full_join(
