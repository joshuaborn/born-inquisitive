---
title: "2006-2010 NSFG Weight Adjustment"
author: "Joshua Born"
output:
  html_document:
    code_folding: hide
...
data_fem <- select(
  ...
  left_join(
    data_preg |>
      group_by(CASEID) |>
      summarize(
        abortions_2002_2005 = sum(OUTCOME == 'INDUCED ABORTION' & Year %in% 2002:2005),
        abortion_2002_2005_age = case_when(
          ...
          any(OUTCOME == 'INDUCED ABORTION' & Year %in% 2002:2005 & AgeAtEndOfPregnancy <= 39) ~ '35-39 years',
        ...
        abortion_2002plus_age = case_when(
          ...
          any(OUTCOME == 'INDUCED ABORTION' & Year >= 2002 & AgeAtEndOfPregnancy <= 39) ~ '35-39 years',
        ...
        birth_2002_age = case_when(
          ...
          any(OUTCOME == 'LIVE BIRTH' & Year == 2002 & AgeAtEndOfPregnancy <= 39) ~ '35-39 years',
        ...
        birth_2003_age =  case_when(
          ...
          any(OUTCOME == 'LIVE BIRTH' & Year == 2003 & AgeAtEndOfPregnancy <= 39) ~ '35-39 years',
        ...
        birth_2004_age =  case_when(
          ...
          any(OUTCOME == 'LIVE BIRTH' & Year == 2004 & AgeAtEndOfPregnancy <= 39) ~ '35-39 years',
        ...
        birth_2005_age =  case_when(
          ...
          any(OUTCOME == 'LIVE BIRTH' & Year == 2005 & AgeAtEndOfPregnancy <= 39) ~ '35-39 years',
  ...
  mutate(
    abortions_2002_2005 = coalesce(abortions_2002_2005, 0),
    abortions_2002_2005_multiplier = if_else(
      abortions_2002_2005 >= 1,
      abortions_2002_2005,
      1
    ),
    across(
  ...
  mutate(
    ...
    Level = factor(
      case_when(
        ...
        Age.of.Mother.9.Code %in% c('40-44', '45-49', '50+') ~ 'Other',
...
extras[[1]] <- c(
  ~abortions_2002_2005_multiplier,
  ~abortion_2002plus_age
)
...
```{r create-survey-objects, dependson=c("save-adjusted-weights"), message=FALSE}
after_fem <- data_fem |>
  select(-WGTQ1Q16) |>
  left_join(
...
after_fem |>
  ...
  summarize(
    Count = n(),
    Est = survey_total(abortions_2002_2005_multiplier)
  ) |>
  full_join(
...
This survey will cover years 2002 to 2005.
...
```{r births-by-year, message=FALSE}
bind_rows(
  read_tsv(
    here('data/NVSS/2002-2005/age_2002.txt'),
    name_repair = 'universal',
...
```{r births-by-year-by-age, message=FALSE}
bind_rows(
  read_tsv(
    here('data/NVSS/2002-2005/age_2002.txt'),
    name_repair = 'universal',
