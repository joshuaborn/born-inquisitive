...
weight_adj_strata[[length(post_stratification_targets)]] <- ~abortion_1980plus_age
...
entropy_extreme_after |>
  ...
  gt() |>
  fmt_number(c(contains('WGT'), 'W5'), decimal = 0)
```
...
after_fem |>
  ...
  full_join(
    ...
    by = join_by(age_race_marital_history)
  ) |>
  mutate(
    Diff = Est - Freq
  ) |>
