...
here::i_am(file.path('deprecated', 'eda', 'number_of_births.Rmd'))
...
**_This document is deprecated. Instead of using tidyverse libraries to load the NSFG data sets using fragments of the SAS program statements, going forward the NSFG data will be loaded into SAS via the SAS program statements, and exports of the data for use with R created from the SAS data sets. Additionally, tidyverse will no longer be used in favor of data.table._**
...
load_nsfg_data_set <- function(filename, path = 'deprecated/data') {
