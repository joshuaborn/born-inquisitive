...
set_mention_count_variable(fem1719dt, 'used_last_3m_method')
...
names(fem1719METHXidxs) <- paste('any_use_12m_method', fem1719METHXidxs, sep = '')
...
set_mention_count_variable(fem1719dt, 'any_use_12m_method')
...
for (x in c(1:2)) {
  fem1719dt[
    fem1719$Data,
    (sprintf('ever_quit_method%d', 30 + x)) := na_to_false(
...
fem1719dt[
  fem1719$Data,
  ever_quit_method33 := na_to_false(
...
set_mention_count_variable(male1719dt, 'used_last_3m_method')
...
set_mention_count_variable(male1719dt, 'any_use_12m_method')
