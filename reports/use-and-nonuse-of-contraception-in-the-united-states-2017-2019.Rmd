...
```{r iud-reason-mentions, dependson='process-fem-data', fig.width=8, fig.height=4, fig.cap='Females by reason(s) mentioned for using hormonal IUD with persons mentioning multiple reasons counted multiple times, among those who used an hormonal IUD either this or the previous month.'}
estimate_NSFG_mentions(
  survey_design = subset(
    get_NSFG_survey_design_for_sex('fem'),
    IUDTYPE == 'Hormonal IUD (such as Mirena, Skyla, Liletta, or Kyleena)' &
