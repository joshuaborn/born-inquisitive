...
```{r, dependson=c('process-fem-data', 'process-male-data'), cache=FALSE}
fem1719dt[, person := 1]
male1719dt[, person := 1]
...
][, .(sex, output = paste(total, total_CI))]

this$fem <- this$dt[sex == 'Female', output]
this$male <- this$dt[sex == 'Male', output]
```
...
Based on the NSFG, there is an estimated `r this$fem` 95\% C.I.[^ci] females and `r this$male` 95\% C.I. males living in households in the United States.  According census data, there are 73,874,470 females and 74,595,017 males living in the United States.[^census] [@us_census_bureau_table_2010] The 95\% confidence intervals of the NSFG-based estimates of population size cover the census-based counts. Thus, the NSFG survey estimates of population size are consistent with known population sizes.[^consistent]

[^ci]: The phrase "95\% C.I." refers to a 95\% [confidence interval](/how-to-scrutinize-a-statistic.html#estimation-error-and-confidence-intervals), and the syntax of stating a point estimate followed by its corresponding 95\% confidence interval in parentheses is used throughout this report. The "M" in the figures refers to "millions," such that "72.6M persons" describes approximately seventy two million, six hundred thousand persons.
...
On the other hand, a major drawback of analysis of contraceptive use at last intercourse is that there is variation among respondents in how long it has been since the last intercourse at the time of the interview. Furthermore, use of contraceptive methods for the purpose of contraception _per se_ is only relevant for sexual intercourse with the opposite sex, though, as seen in Section \@ref(use-of-contraceptive-methods-for-other-reasons), contraceptive methods are sometimes used for other purposes than contraception.

Therefore, this section analyses a subsample of respondents who have had sexual intercourse with a member of the opposite sex within 3 months prior to being interviewed. This implies that estimates in this section pertain to a subdomain of persons in the United States who had intercourse with someone of the opposite sex in the past 3 months. There are approximately `r this$fem` females and `r this$male` males in this subdomain. (Table \@ref(tab:sexually-active))
...
style_and_combine_totals_and_percentages_vertically(
  ...
  set_caption('Persons who used any method of contraception at their last sexual intercourse, among those who have had intercourse with the opposite sex in the past 3 months.')
```

Table \@ref(tab:used-last-3m-at-all) contains estimates of the number of persons who used at least one method of contraception at their last intercourse.

Some respondents who in their answers to other questions reported having an active sterilizing operation, such as a tubal ligation or vasectomy, or having last had intercourse with a spouse or cohabitating partner with an active sterilizing operation did not report using said sterilizing operation as a contraceptive method at their last intercourse.

This is may be due to confusion on the part of respondents with questions referring to a specific encounter of sexual intercourse, since such sterilizing operations were performed at some time before the encounter. Therefore, all those who reported having an active sterilizing operation or last intercourse with a spouse or cohabitating partner with an active sterilizing operation were counted as using such sterilizing operations as a method of contraception at last intercourse.


### Reason for Nonuse

Domain: Persons who had sexual intercourse with someone of the opposite sex in the 3 months preceding the interview and did not use a method of contraception during most recent intercourse
...
Domain: Persons who had sexual intercourse with someone of the opposite sex in the 3 months preceding the interview, did not use a method of contraception during most recent intercourse, and neither are nor had last intercourse with someone who is pregnant, postpartum, trying to conceive, or physically infertile
...
### Sexual Inactivity (with Opposite Sex)
...
estimate_NSFG_mentions_in_subdomains(
  ...
  format = 'METH3MF',
  skip = c(20:22)
)[!is.nan(percentage_CI_low)] |> plot_percentages_with_CIs()
```
