...
fem1719dt[,
  used_last_3m_status := factor(
    fcase(
      ...
      POSIBLPG == 'No',
        'Physically infertile not due to sterilization procedure',
      POSIBLMN == 'No' & (
        P1YRELP == 'Current cohabiting partner' |
        P1YRELP == 'Current husband or (current husband from whom she is separated)'
      ),
        'Last intercourse was with partner who is physically infertile not due to sterilization procedure',
...
The "Physically infertile not due to sterilization procedure" category is explored in Section \@ref(reason-for-physical-infertility-not-due-to-sterilization-procedure).
...
The proportion of males who are "Only attracted to females" is approximately 92.4\% among those who have had intercourse with a female in the past 3 months, but only 79.5\% among those who have not, and the proportion "Only attracted to males" is approximately 0.1\% among those who had intercourse with a female in the past 3 months, but is 6.4\% among those who have not. (Table \@ref(tab:male-sex-attraction))

Similarly, among females who have had sexual intercourse with a male in the past 3 months, approximately 0.5\% describe themselves as "Mostly attracted to females" and 0.2\% as "Only attracted to females." However, among those that have not had intercourse with a male in the past 3 months, 4.9\% describe themselves as "Mostly attracted to females" and 4.4\% as "Only attracted to females." (Table \@ref(tab:fem-sex-attraction))

The proportions categorized by attraction to the sexes between those who have had intercourse with a male in the past 3 months and those who have not is statistically significant by a Chi-squared test with a second-order Rao-Scott correction. **_interpret this better here_** Thus, it is likely that some number of persons are not sexually active currently with the opposite sex due to attraction primarily to the same sex.


### Reason for Physical Infertility Not Due to Sterilization Procedure
