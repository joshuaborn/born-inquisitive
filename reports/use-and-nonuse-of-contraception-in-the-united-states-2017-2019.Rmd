...
Those who use condom in conjunction with another method do so with a variety of other methods, though pill and to a lesser extent withdrawal are used in conjunction with condoms more than other methods, especially among males. (Figures \@ref(fig:fem-other-with-condom) and \@ref(fig:male-other-with-condom))
