...
this$maleCI <- this$df[4, 4]
```

Based on the NSFG, there is an estimated `r this$fem` [95\% C.I.[^ci] `r this$femCI`] females and `r this$male` [95\% C.I. `r this$maleCI`] males living in households in the United States.  According census data, there are 73,874,470 females and 74,595,017 males living in the United States.[^census] [@us_census_bureau_table_2010] The 95\% confidence intervals of the NSFG-based estimates of population size include the census-based counts. Thus, the NSFG survey estimates of population size are consistent with known population sizes.[^consistent]
