...
```{r hormonal-iud-quit-reasons, dependson='process-pill-quit'}
estimate_NSFG_mentions(
  survey_design = subset(
    get_NSFG_survey_design_for_sex('fem'),
    ever_quit_method32
...
```{r hormonal-iud-specific-quit-reasons, dependson='process-fem-data'}
estimate_NSFG_mentions(
  survey_design = subset(
    get_NSFG_survey_design_for_sex('fem'),
    ever_quit_method32 & (
...
```{r copper-iud-quit-reasons, dependson='process-pill-quit'}
estimate_NSFG_mentions(
  survey_design = subset(
    get_NSFG_survey_design_for_sex('fem'),
    ever_quit_method31
...
```{r copper-iud-specific-quit-reasons, dependson='process-fem-data'}
estimate_NSFG_mentions(
  survey_design = subset(
    get_NSFG_survey_design_for_sex('fem'),
    ever_quit_method31 & (
