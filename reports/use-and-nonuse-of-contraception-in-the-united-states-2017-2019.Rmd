...
```{r discontinuation-of-methods, dependson='process-fem-data'}
estimate_NSFG_mentions_in_subdomains(
  row_estimation_function = function(x) {
    estimate_row_total_and_percentage(
...
```{r condom-quit-reasons, dependson='process-fem-data'}
estimate_NSFG_mentions(
  survey_design = subset(
    get_NSFG_survey_design_for_sex('fem'),
    ever_quit_method4
...
```{r condom-quit-specific-reasons, dependson='process-fem-data'}
estimate_NSFG_mentions(
  survey_design = subset(
    get_NSFG_survey_design_for_sex('fem'),
...
```{r pill-quit-reasons, dependson='process-fem-data'}
estimate_NSFG_mentions(
  survey_design = subset(
    get_NSFG_survey_design_for_sex('fem'),
    ever_quit_method3
...
```{r pill-quit-specific-reasons, dependson='process-fem-data'}
estimate_NSFG_mentions(
  survey_design = subset(
    get_NSFG_survey_design_for_sex('fem'),
