...
The methods most commonly used in conjunction with pills are condoms and withdrawal, though several other methods are occassionally used with pills, as well. (Figures \@ref(fig:fem-other-with-pill) and \@ref(fig:male-other-with-pill))
