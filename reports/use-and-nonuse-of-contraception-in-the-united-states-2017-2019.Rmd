...
male1719dt[,
  not_aware := factor(fifelse(
    CWPLUSE2 == "Don't know" |
      ...
      PXLSXPRB == 'Yes' |
      PXLSXPRB == "Don't know",
    'Reports not knowing if partner used contraceptive method during last intercourse',
    'Does not report not knowing if partner used contraceptive method during last intercourse'
  ))
]
...
Table \@ref(tab:used-last-3m-at-all) contains estimates of the number of persons who used at least one method of contraception during their last intercourse. For both females and males, over three quarters of persons sexually active with the opposite sex used at least one method of contraception during their most recent intercourse. A slightly greater proportion of females report using contraception than males.
...
Description: By number of methods used during last intercourse
...
* Use only 3 significant figures for totals estimates
