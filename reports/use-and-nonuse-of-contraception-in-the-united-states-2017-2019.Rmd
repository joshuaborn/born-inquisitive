...
The size of the subdomain of condom users who are asked about their motives for condom use by the NSFG is `r this$fem` females and `r this$male` males. However, it should be noted this subdomain specifically contains users of condoms for vaginal intercourse with the opposite sex, for which contraception is a possible motive, and does not address non-vaginal or same-sex condom use.
...
The vast majority of persons who use condoms during vaginal intercourse do so motivated by contraception, at least in part, though these persons are split approximately equally between those who are exclusively motivated by contraception and those motivated by both contraception and prevention of sexually transmitted diseases. (Table \@ref(tab:motive-for-condom))
