...
Based on the NSFG, there is an estimated `r this$fem` females and `r this$male` males living in households in the United States. (Table \@ref(tab:population-size)) According census data, there are 73,874,470 females and 74,595,017 males living in the United States.[^census] [@us_census_bureau_table_2010] The 95\% confidence intervals[^ci] of the NSFG-based estimates of population size include the census-based counts. Thus, the NSFG survey estimates of population size are consistent with known population sizes.[^consistent]
