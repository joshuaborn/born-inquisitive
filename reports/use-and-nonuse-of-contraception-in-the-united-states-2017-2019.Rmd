...
fem1719dt[,
  sexually_active_3m := factor(fifelse(
    SEX3MO == 'YES',
    'Sexually active with opposite sex in past 3 months',
    'Not sexually active with opposite sex in past 3 months'
  ))
]
...
fem1719dt[,
  used_last_3m := factor(fifelse(
    ...
    'Used contraception at last intercourse',
    'Did not use contraception at last intercourse'
  ))
]
...
[^census]: As of the writing of this report, the full results of the 2020 U.S. Census have not been released. Therefore, the 2010 Census was used. Census counts from 2010 can be expected to be lesser than what would have been the census counts from the 2017-2019 time frame, if there was any population growth between 2010 and 2017.

Furthermore, the point estimates of population size based on the NSFG are quite close to the census counts, though the census counts are more than a million persons higher for both females and males. Unlike the NSFG estimates, the U.S. Census does count those without a current residential address and those living in group housing, which might account for these differences.



### Use of Contraception at Most Recent Intercourse

Domain: Persons aged 15-49 living in households in the United States as estimated by the NSFG

Description: By whether person had intercourse with someone of the opposite sex during the 3 months preceding the interview

```{r, dependson=c('process-fem-data', 'process-male-data')}
fem1719dt[, person := 1]
male1719dt[, person := 1]

estimate_and_combine_NSFG_totals_and_percentages(~sexually_active_3m)
```

#### Domain Size

Domain: Persons aged 15-49 living in households in the United States who had intercourse with the opposite sex in the 3 months preceding the interview

Description: By whether used a method of contraception during last intercourse
...
style_and_combine_totals_and_percentages_vertically(
  ...
  estimate_totals_and_percentages(
    ...
    subset(
      get_NSFG_survey_design_for_sex('fem'),
      sexually_active_3m == 'Sexually active with opposite sex in past 3 months'
    )
  ),
  'Males',
  estimate_totals_and_percentages(
