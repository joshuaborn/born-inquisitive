...
style_and_combine_totals_and_percentages_vertically(
  ...
  set_caption('Persons other contraceptive method(s) used during last intercourse, among persons who used a calendar-based method of contraception during sexual intercourse with someone of the opposite sex in the past 3 months.') |>
  set_width(0.75) |>
  set_col_width(2, 2)
```
