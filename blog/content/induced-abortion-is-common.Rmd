...
```{r Guttmacher-APC-counts, fig.width=5, fig.height=3.75, fig.cap="Number of induced abortions of pregnancy in the United States per year, based on the Abortion Provider Census by the Guttmacher Institute. [@maddow-zimet_pregnancies_2022] [@jones_abortion_2022]"}
