...
Gallup_overturn_roe_v_wade <- tribble(
  ~Month, ~yes_overturn, ~no_not_overturn, ~no_opinion, ~half_sample,
...
```{r plot-Gallup-overturn-roe-v-wade, cache=FALSE, fig.cap="Distributions of responses over time to question 'Would you like to see the Supreme Court overturn its 1973 Roe v. Wade decision concerning abortion, or not?' or in 2023 'Do you think overturning Roe versus Wade was a good thing or a bad thing?' [@gallup_abortion_in_depth]"}
