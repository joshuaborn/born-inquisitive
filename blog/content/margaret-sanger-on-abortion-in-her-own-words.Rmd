...
output:
  blogdown::html_page:
    ...
    toc: true
    toc_depth: 5
summary: 'Birth control pioneer and Planned Parenthood founder Margaret Sanger felt that abortion was "taking life" and had the explicit goal of ending the use of abortion for family limitation.'
tags: ["history", "reproductive responsibility", "birth control", "induced abortion", "third-person"]
title: "Margaret Sanger on Abortion in Her Own Words"
---

![
_Margaret Sanger in 1916._<br/>
Library of Congress, Prints & Photographs Division,
[[LC-DIG-ggbain-20859]](http://www.loc.gov/pictures/item/2014700793/)
](/images/margaret-sanger.jpeg){alt="Margaret Sanger seated at a table and holding an open book."}
...
Margaret Sanger was born and raised in Corning, New York. [@sanger_1938, 1-32] As an adult she had a career as a nurse, settled down in and around New York City, and started a family. [@sanger_1938, 45-67] It was while working as a nurse that she observed the conditions excessive childbearing had created, particularly among New York City's poor. She observed families living in tenements with more children than they could care for, how prevalent infant mortality was, how women's bodies taxed into ill health and premature death, and how women were resorting to abortion[^definition] in desperation. [@sanger_1938, 86-89]
...
](/images/margaret-sanger-fania-mindell-courthouse.png){alt="Numerous men, women, and children in overcoats and formal attire surround Margaret Sanger and Fania Mindell as they stand on the steps to a building."}
...
Finally, in June of 1937, the American Medical Association asserted that physicians now had the legal right to prescribe contraceptives, and the association recommended that standards be researched and that contraception be taught in medical schools. Margaret Sanger considered this the fulfillment of her work. [@sanger_1938, 430] She soon dissolved the National Committee on Federal Legislation on Birth Control and moved to Arizona.

Despite her partial retirement from public life, Margaret Sanger would continue to be involved in efforts that would have a lasting impact on the state of contraception. Today, the most popular reversible form of contraception practiced among women in the United States is the use of the combined oral contraceptive pill. [@nsfg] In the 1950s, Margaret Sanger was instrumental in securing funding for research and development of Enovid, the first such pill brought to market in the United States. [@eig]
...
![
_The outside of Margaret Sanger's first birth control clinic, which was opened in the Brownsville neighborhood of Brooklyn on October 16, 1916 and closed by the authorities after only nine days._<br/>
Library of Congress, Prints & Photographs Division, NYWT&S Collection, 
[[LC-USZ62-138888]](https://www.loc.gov/item/2010645731/)
](/images/brownsville-clinic.jpeg){alt="Numerous strollers are parked on a sidewalk outside of a building. A few women sit on a bench. A child plays in the street."}
...
](/images/brownsville-clinic-inside.jpeg){alt="Fania Mindell sits in a chair facing to the side. Margaret Sanger stands next to a side table containing jars of towels, holding a bowl and facing the camera."}

While it is true that Margaret Sanger often spoke and wrote critically of abortion because of its potential to do harm to the woman involved, we see here that she had the [moral](/moral-skepticism.html) sentiment that abortion is "taking life," as well.
...
Abortion today is a very political issue in the United States, and politics tends to produce the [basest excuse for dialogue known to humankind](/political-rhetoric-as-shibboleths.html). One aspect of this baseness is the tendency to divide the world to "us" and "them." This division around abortion is typically expressed in the dichotomy between so-called "pro-life" and "pro-choice" factions.
...
and is not modified.
](/images/margaret-sanger-bust.jpg){alt="A bronze bust of Margaret Sanger under museum lighting."}
...
](/images/patrick-joseph-hayes.jpeg){alt="Patrick J. Hayes sits in a chair, wearing clergical robes and a cape."}

While the assessment that contraception is worse than abortion may not be common among Catholics today, the official Catholic Church stance is still that of Pope Paul VI's _Humanae Vitae_ of July 25, 1968, which affirmed that "artificial" contraception is a sin _per se._ "Artificial" contraception in this context includes nearly every form of contraception, allowing only methods based on restriction of sexual intercourse to the infertile periods of a woman's reproductive cycle.
...
In the past, the Planned Parenthood Federation of America has issued the "Margaret Sanger Awards" supposedly in her honor. Sometimes these awards were given to individuals who advanced contraception, such as John Rock, MD, or to social luminaries in general, such as Martin Luther King, Jr. However, these awards were all too often given to individuals who have done nothing to advance contraception, but instead recognized individuals for their work in the advancement of abortion. While organizations can have whatever ideology their constituency prefers and call attention to whomever embodies such ideology, these instances of "Margaret Sanger" awards were misappropriations of her name.
...
](/images/margaret-sanger-and-ishimoto-shizuko.jpg){alt="Ishimoto Shizuko holds a parasol that she shares with Margaret Sanger, who stands next her. On the other side of Margaret Sanger is her son Grant, who has his hands in his pockets."}
...
Margaret Sanger's published books are in the public domain. Many are freely available from [Project Gutenberg](http://www.gutenberg.org/ebooks/author/693) or from public libraries. Most of the discussion of abortion in [_Margaret Sanger: an autobiography_](http://www.gutenberg.org/ebooks/56610) is already included in this article. Small portions of "Woman's Struggle for Freedom" and "Contraceptives or Abortion," the second and tenth chapters of _[Woman and the New Race](http://www.gutenberg.org/ebooks/8660),_ respectively, are included in this article, but the rest of those chapters include substantial discussion of abortion.

New York University maintains a [Margaret Sanger Papers Project](https://sanger.hosting.nyu.edu/) and have made a portion of their collection available online. This was used as a source for most of the periodical articles authored by Margaret Sanger cited herein.

The Sophia Smith Collection at Smith College is a repository for many [Margaret Sanger papers](https://libraries.smith.edu/special-collections/about/sophia-smith-collection-womens-history). This was used as a source for the letter containing the infamous "word to go out that we want to exterminate the Negro population" quote.


## Corrections

* Originally, the page numbers used in citations in this article were incorrect. (This was due to electronic renderings of books using their own page numbering schemes, and this was fixed by verifying page numbers with the paper versions of books.)
...
* The "Accusations of Attempting to Exterminate Ethnic Groups" section was expanded to discuss Margaret Sanger's advocacy for eugenics, since no direct discussion of her eugenics advocacy was included in the original article.
