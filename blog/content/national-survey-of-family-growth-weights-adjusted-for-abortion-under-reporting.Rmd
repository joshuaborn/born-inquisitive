...
When using the adjusted weights, estimates of the number of births in each year of a survey's analysis period, and estimates of the number of induced abortions in the entirety of each survey's analysis period should match external counts.
