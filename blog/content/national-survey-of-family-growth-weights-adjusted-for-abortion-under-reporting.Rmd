...
Additionally, for those replicate weights that use the jackknife scheme, some statistical software requires a list of scaling factors. Scaling factors for survey weights that use the jackknife scheme are included in the CSV files linked below.
...
The below SAS program will print out estimates of the population of women in the United States of reproductive age by age, based on the Cycle 6 (2002) of the NSFG, which uses the balanced repeated replication weight scheme.
...
The below SAS program also prints out estimates of the population of women in the United States of reproductive age by age, but based on the 2006-2010 version of the NSFG, which uses jackknife replicate weight scheme instead of balanced repeated repetition. Because of this, the jackknife coefficients must also be loaded.
...
The example R programs use the [`srvyr`](http://gdfe.co/srvyr/) library and two [`tidyverse`](https://www.tidyverse.org/) libraries to process input and output from the `survey` library.

#### Female Respondents File -- Balanced Repeated Replication

The below R program will print out estimates of the population of women in the United States of reproductive age by age, based on the Cycle 6 (2002) of the NSFG, which uses the balanced repeated replication weight scheme.
...
The below R program prints out estimates of the population of women in the United States of reproductive age by age, based on the 2006-2010 version of the NSFG, which uses jackknife replicate weight scheme instead of balanced repeated repetition. Because of this, the jackknife coefficients must also be loaded.
