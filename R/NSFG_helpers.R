...
set_NSFG_2017_2019_data <- function() {
  ...
  assign('fem1719formats', copy(fem1719$Formats), pos = 1)
  assign('male1719', load_NSFG_data('2017_2019', 'Male'), pos = 1)
  assign('male1719dt', copy(male1719$Data), pos = 1)
  assign('male1719formats', copy(male1719$Formats), pos = 1)
}
...
factorize_NSFG_variable <- function(x, name, sex = 'fem', fill_na = TRUE) {
