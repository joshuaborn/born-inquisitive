...
![
_**Figure 1:** Two diagrams illustrating conditions for truth, in which mental models correspond to the external world. The left diagram illustrates an individual who believes that a certain road is open when it is indeed open, and the right diagram illustrates an individual who believes that the road is closed when it is indeed closed._
](/images/two-true-beliefs.svg)

![
_**Figure 2:** Two diagrams illustrating conditions for falsity, in which mental models fail to correspond to the external world. The left diagram illustrates an individual who believes that a certain road is open when it is actually closed, and the right diagram illustrates an individual who believes that the road is closed when it is actually open._
...
When a mind encounters evidence that is consistent with a descriptive mental model, then it is prudent for the mental model to persist. _When a mind encounters evidence that contradicts a descriptive mental model, then it is prudent for the mental model to be amended,_ in order to better agree with the external world, such as in Figure 3. Thus, empirical evidence prompts the revision of false beliefs to better approximate true beliefs.

![
_**Figure 3:** A diagram illustrating belief revision, in which a mental model is changed to be in agreement with the external world after empirical evidence is observed. The left diagram illustrates an individual who believes a certain road is open. The middle diagram illustrates the same individual who has now encountered the road and observed that the road is closed. The right diagram illustrates the individual now believes the road is closed._
...
For instance, if an individual named Zhaohui says, "murder is wrong," then the corresponding attitudinal proposition is "Zhaohui disapproves of murder" or "Zhaohui is morally opposed to murder" or "Zhaohui feels that murder is wrong."

While it makes no sense to attempt to evaluate the truth or falsity of the moral sentiment "murder is wrong" itself, descriptive mental models _can_ be correct or incorrect _about_ Zhaohui's normative mental model. From the perspective of the more than seven billion human minds on the Earth, Zhaohui's mind is part of their external world.

![
_A diagram illustrating a true belief about an attitudinal proposition._<br/>
](/images/image.svg)

Such attitudinal propositions make a different kind of claim than the objective statement that "murder is wrong." They make claims about subjective mental states, claims that _are_ true or false.
