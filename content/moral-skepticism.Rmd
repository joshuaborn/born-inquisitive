...
![
_Figure 1: Two diagrams illustrating conditions for truth, in which mental models correspond to the external world. The left diagram illustrates an individual who believes that a certain backpack weighs 10 kilograms when it indeed does weigh 10 kilograms, and the right diagram illustrates an individual who believes that the backpack weighs greater than 10 kilograms when it does indeed weigh greater than 10 kilograms._
](/images/two-true-beliefs-2.svg)

![
_Figure 2: Two diagrams illustrating conditions for falsity, in which mental models fail to correspond to the external world. The left diagram illustrates an individual who believes that a certain backpack weighs greater than 10 kilograms when it actually weighs 10 kilograms, and the right diagram illustrates an individual who believes that the backpack weighs 10 kilograms when it actually weighs greater than 10 kilograms._
...
![
_Figure 5: A diagram illustrating a normative mental model, which, unlike Figure 4, contains a red circle-backslash symbol to represent the additional element of moral disapproval._
...
[^fallacy]: This kind of fallacy is different from the fallacies discussed in [articles tagged "reasoning about evidence"](/tags/reasoning-about-evidence.html) in this blog. The critical thinking articles discuss mistakes in interpreting evidence, regardless of one's philosophical position. The fallacy of externalization is a fallacy according to moral skepticism, but is a feature of moral realism.
