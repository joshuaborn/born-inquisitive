...
For instance, mental models illustrated in Figure 2 are flawed. In the first case, time might be wasted when the individual attempts to travel down a closed road, necessitating an impromptu detour. In the second case, the individual might use an unnecessarily circuitous route. On the other hand, the individual in either of the cases illustrated in Figure 1 can plan an optimal route without unnecessary detours.
...
![
_**Figure 6:** A diagram illustrating what an analogue of belief revision would be like for normative mental models. The left diagram illustrates an individual who disapproves of murder. The middle diagram illustrates the same individual witnessing a murder. The right diagram illustrates the individual changing from disapproval to approval of murder, as symbolized by inclusion of a the check mark._
](/images/nonsensical-moral-revision.svg)

![
_**Figure 7:** A diagram illustrating a reaction of a moral mental model to the observation of an act of which it disapproves._
](/images/image.svg)
...
![
_**Figure 8:** A diagram illustrating true beliefs about attitudinal propositions._<br/>
](/images/image.svg)

Such attitudinal propositions make a different kind of claim than the objective statement that "murder is wrong." They make claims about subjective mental states, claims that _are_ true or false. Thus, while there are no moral truths and no moral knowledge, there can be truths and knowledge about moral sentiments.

![
_**Figure 9:** A diagram illustrating false beliefs about attitudinal propositions._<br/>
](/images/image.svg)
...
Statements about moral constructs are fictional for the same underlying reason that it is a mistake to interpret moral sentiments as true or false. All truths describing morality are describing normative mental models, however indirectly this may be. Moral sentiments do this indirectly by ascribing goodness or badness to things in the non-mental world, such as the act of murder. Moral constructs take this indirection even further by inventing abstractions that do not describe anything in the non-mental world, such as justice, virtue, etc.

While all truth about morality describes normative mental models, moral fictions are a tool to create the impression that one is discussing something external to one's own mind. This lie may be termed the "fallacy of externalization."[^fallacy] Moral fictions use the same language used to describe things that have physical existence independent of one's own mind, such as gravity, oxygen, or tectonic shift. The use of such language is a way to pretend that one is describing something _other_ than one's own normative mental model. 
...
![
_**Figure 10:** A diagram illustrating moral self-awareness._<br/>
](/images/image.svg)
