...
output:
  blogdown::html_page:
    ...
    toc: true
    toc_depth: 5
summary: "Searching for moral knowledge is delusional. Differences between descriptive and normative mental models imply that truth and falsity do not apply to morality and that moral constructs are fictions."
tags: ["opinion", "philosophy", "third-person"]
...
![
_Figure 1: Two diagrams illustrating conditions for truth, in which mental models correspond to the external world._
](/images/two-true-beliefs-2.svg){alt="Two diagrams each with a scale on which is placed a 10 kilogram weight and a backpack and each with a thought bubble above a person that contains a similar scale. In the left diagram, both scales are balanced. In the right diagram, both scales tip in the direction of the backpack."}

![
_Figure 2: Two diagrams illustrating conditions for falsity, in which mental models fail to correspond to the external world._
](/images/two-false-beliefs-2.svg){alt="Two diagrams similar to Figure 1, except in the left diagram, the scale in the thought bubble is tipped toward the backpack while the scale in the foreground is balanced, and in the right diagram, the scale in the thought bubble is balanced while the scale in the foreground is tipped in the direction of the backpack."}
...
![
_Figure 3: A diagram illustrating belief revision, in which a mental model is changed to agree with the external world after empirical evidence is observed._
](/images/belief-revision-2.svg){alt="A left panel illustrates an individual who believes a backpack weighs 10 kilograms. A middle panel illustrates the same individual has now seen the backpack tip a scale when opposite a 10-kilogram weight. A right panel illustrates the individual now believes the backpack weighs greater than 10 kilograms."}
...
![
_Figure 4: A diagram illustrating a descriptive rather than normative mental model, in which an individual witnesses a murder in progress and believes there is a murder taking place._
](/images/not-moral-sentiment.svg){alt="In the foreground, there is an outline of a man standing above another with an axe, and in a thought bubble above a person, there is the same outline."}
...
![
_Figure 5: A diagram illustrating a normative mental model. The red circle-backslash symbol represents the additional element of moral disapproval._
](/images/moral-sentiment.svg){alt="The same as Figure 4, but with a red circle-backslash symbol superimposed upon the version of the scene in the thought bubble."}
...
![
_Figure 6: A diagram illustrating how a normative mental model is_ not _expected to react to contradiction with the external world._
](/images/nonsensical-moral-revision.svg){alt="A left panel with a thought bubble above a person containing the outline of a man standing above another with an axe with a red circle-slash symbol superimposed above it. The middle panel with the same person encountering such a scene in the foreground. A right panel similar to the left panel, but now the red-circle symbol in the thought bubble has been replaced with a green checkmark symbol."}

![
_Figure 7: A diagram illustrating how a normative mental model_ is _expected to react to contradiction with the external world._
](/images/world-revision.svg){alt="Left and middle panels identical to Figure 6. The left panel illustrates an individual who disapproves of murder. In the right panel, the red circle-slash symbol remains in the thought bubble, and \"Stop!\" appears in a speech bubble next the person."}
...
![
_Figure 8: Two diagrams illustrating true beliefs about attitudinal propositions._
](/images/true-attitudinal-propositions.svg){alt="A left diagram with a teal person icon with a thought bubble containing butchered meat with red circle-slash superimposed upon it, and an orange icon person with a thought bubble that contains a replica of the teal icon person and thought bubble. A right diagram that is identical except the red circle-slash symbols are replaced with green checkmark symbols."}

![
_Figure 9: Two diagrams illustrating false beliefs about attitudinal propositions._
](/images/false-attitudinal-propositions.svg){alt="Identical to Figure 8, except the left panel has a green checkmark in the orange person icon's thought bubble version of the teal person icon's thought bubble, and the right panel has a red circle-slash symbol in the orange person icon's thought bubble version of the teal person icon's thought bubble."}
...
[^fallacy]: This kind of fallacy is different from the fallacies discussed in [articles tagged "fallacies"](/tags/fallacies.html) in this blog. These articles discuss mistakes in interpreting evidence, regardless of one's philosophical position, whereas the fallacy of externalization is a fallacy according to moral skepticism, but is a feature of moral realism.
...
![
_Figure 10: A diagram illustrating moral self-awareness._
](/images/self-awareness.svg){alt="A teal person icon with a thought bubble that contains the same teal person icon with another thought bubble. The interior thought bubble contains an axe murder scene with a red circle-slash symbol superimposed upon it."}
