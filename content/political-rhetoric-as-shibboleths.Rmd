...
output:
  blogdown::html_page:
    ...
    toc: true
    toc_depth: 5
summary: "Slogans of political rhetoric function as shibboleths -- markers of tribal allegiance devoid of content -- and so promote conformity, superficiality, and exclusion of non-binary viewpoints."
tags: ["editorial", "third-person"]
...
and is not modified.
](/images/jordan-river.jpg){alt="A bend in the Jordan River with green, gently rippling water surrounded by much vegetation."}
...
](/images/left-wing-shibboleths.jpg){alt="A lawn sign that contains a United States flag, but with various slogans superimposed upon it."}
