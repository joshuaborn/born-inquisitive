...
Political rhetoric comprises some of the worst excuses for dialogue known to human civilization. In this article, I use the concept of a shibboleth, which comes from a story in the Hebrew Bible, to explain a function of slogans in the context of political rhetoric, and I examine how my worldview deals with such shibboleths.
...
The implications for how my worldview deals with the shibboleths of others are slightly more subtle. Generally, once I identify some verbiage as a shibboleth, I stop trying to make sense of it _per se._ I make note that so-and-so an individual has expressed allegiance to some group defined by this shibboleth, and that is the end of it.

For candidate shibboleths posted to social media or shouted at a rally, the initial encounter with them is the end of my interaction with them entirely. If I am engaged in an actual conversation with someone who uses what might be a shibboleth, I try to give my interlocutor the benefit of the doubt and ask questions that might lead to more substantial thinking. If this is successful, then critical thinking can be applied. If nothing substantial is produced, then I am left to identify the original verbiage as a shibboleth, and no further critical thinking need take place.


## Limitations of Utility

Even when learning _about_ shibboleth usage instead of _from_ shibboleths, the information gleaned is not much. Knowing that an individual identifies as a member of a group does not reveal the details of the individual's beliefs, attitudes, and experiences, because any large population exhibits variation. To think otherwise is to subject oneself to the fallacies of generic thinking.
