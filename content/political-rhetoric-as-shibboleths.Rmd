...
Political rhetoric comprises some of the worst excuses for dialogue known to human civilization. In this article, the concept of a shibboleth, which comes from an example of sectarian conflict in the Hebrew Bible, is used to explain a function of slogans in the context of political rhetoric, and the characteristics of shibboleths that make them inimical to independent, critical thinking &ndash; namely conformity, superficiality, and exclusion of non-binary viewspoints &ndash; are examined.

<!--more-->

## Introduction

Inasmuch as a conversation consists of two or more individuals engaged in at least two activities -- communicating their own thoughts and understanding their interlocutor's thoughts -- political rhetoric often fails to merit being labeled a "conversation." It can fail to be a conversation in the sense of the latter activity, when one has no genuine interest in even attempting to understand what the other party is communicating.
...
It is naive to believe that the purpose of all usage of language is to communicate information. Such is not the purpose of the sort of political rhetoric identified here. Therefore, one cannnot be enlightened _by_ this sort of political rhetoric. However, one can be enlightened in how one thinks _about_ political rhetoric.
...
This led to a problem for the Gileadites blockading the river. How would a Gileadite know if any given person caught crossing the River Jordan were a fleeing Ephraimite or just a Gileadite going about one's business? The solution told by the passage is that the Gileadites blockading the river challenged the river crossers to say a specific word, which was pronounced one way in the Gileadite dialect and another way in the Ephraimite dialect. If a river crosser pronounced it the Gileadite way, the individual would be spared, but if a river crosser pronounced it the Ephraimite way, the individual would be killed.
...
These traits of shibboleths make them useful for simple-minded, tribal worldviews that construe the intellectual landscape as a battle between "us" and "them." They serve no use for worldviews that value independent thinking instead of conformity and critical thinking instead of superficiality. Indeed, such worldviews are apt to feature the very sort of viewpoints that the use of shibboleths attempts to exclude.

Thus, those who value independent, critical thinking are apt to shun the use of shibboleths. However, it is unavoidable to encounter _others_ using shibboleths. There is nothing to be gained from trying to learn _from_ such shibboleth usage directly. However, two things can be gleaned _about_ an incident of shibboleth use. The first is that the user of the shibboleth has indirectly proclaimed an association with a certain faction. The second is that the user of the shibboleth has a simplistic worldview characterized by superficiality and conformity.
