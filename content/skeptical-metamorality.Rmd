...
## Relationships between Descriptive Beliefs and Moral Sentiments

Descriptive beliefs can inform moral sentiments in at least two ways: when going from a general moral sentiment to a specific one, and when learning of mitigating circumstances.

For example, if one has the general moral sentiment that stealing is wrong, and one learns that Diya is a habitual thief, then one logically will have a disapproving moral sentiment toward Diya's behavior. This is an example of descriptive beliefs informing a more specific moral sentiment from a more general one. This sort of informative import is sound only if the descriptive belief is actually true. One would feel foolish having asserted the moral sentiment "Diya is bad" because one believed Diya was a habitual thief, if one found out that belief was false and Diya had never stolen in her life.

Furthermore, new descriptive beliefs sometimes mitigate specific moral sentiments. For instance, suppose it were confirmed that Diya is indeed a habitual thief. If one has the general moral sentiment that stealing is wrong, then it is only logical that one would have a disapproving moral sentiment toward Diya. However, if one were to go on to learn that Diya only steals as much as she needs to feed the orphan children she takes care of, then this additional information might mitigate one's moral sentiments toward Diya. Again, this mitigation is only sound if the descriptive belief is actually true. One would feel foolish if one found out the story with the orphan children was a ruse concocted by Diya to evade moral censure.

While these examples illustrate that is is possible for descriptive beliefs to inform the specifics of moral sentiments, the converse is not true. For the questions of whether or not Diya is, in fact, a habitual thief or whether or not Diya does, in fact, take care of orphan children, one's opinions of moral rectitude or transgression are entirely irrelevant.

Thus, the relationship between descriptive beliefs and moral sentiments is entirely one way. No amount of moralizing can inform questions about matters of fact about the external world. This is a direct result of moral sentiments being normative, rather than descriptive. Whether it would be good or bad if something happens has no bearing on whether it actually has happened or not.
...
### Subject vs Predicate Usage

### Meaningless or Universally False
