...
However, while it may be the case that moral constructs _should_ be interpreted as useful fictions, many individuals have, in point of fact, not interpreted them as such, but instead taken them literally. Pages and pages of philosophical treatises have been devoted to speculating about "the Good," "justice," "virtue," "rights," etc. Even today, in contemporary news outlet there is much hand-wringing about the nature of "justice" or "rights."

An issue with the useful fictions interpretation is that, while it may make a mind internally consistent, this is largely hidden from the external world. An individual who ironically speaks about "justice" or "rights" with the understanding that these are useful fictions is not readily distinguishable from someone who literally speaks about "justice" or "rights." This leaves those with useful fiction interpretations with one of two options: to call out repeatedly that moral constructs are fictional every time they are discussed, or to maintain a secret worldview indistinguishable from worldviews that are diametrically opposed to it.
...
A final practice is to avoid moral constructs entirely. [...]
...
A critical thinker is compelled to believe what is true and disbelieve what is false. All that remains is how one feels. The only enlightenment that can be attained about this is to be _aware_ of how one feels and to abstain from trying to post hoc rationalize it. Then, one can investigate one's self with the same tools of inquiry &ndash; such as empirical evidence, investigation into causes, etc &ndash; that one might use to investigate any other fact about the world.
