...
## Definition of Descriptive versus Normative Mental Models
...
## Implications of Descriptive versus Normative Mental Models
### No Moral Truth
...
## Definition of Moral Constructs
...
A third interpretation of statements about moral constructs is that they are not to be taken literally, but are _useful fictions,_ like a fable, intended to remind individuals to act in accord with some moral system. However, this is a dubious interpretation, since it is predicated on the supposition that everyone speaking, listening, writing, and reading about moral constructs is consciously aware that moral constructs do not actually exist.
...
Regardless if statements about moral constructs are interpreted as neither true nor false, always false, or false but in a way that has utility, the important point that all these interpretations have in common is that statements about moral constructs are not literally true. Thus, such constructs are _moral fictions._
