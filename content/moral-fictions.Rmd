...
One interpretation is to take statements about moral constructs at face value. Statements about "justice," "virtue," "righteousness," etc, are _trying_ to describe some feature of the non-mental world. However, since there are no features of the non-mental world such as justice, virtue, righteousness, etc, to describe, all of these sort of statements fail. Therefore, all such statements about moral constructs are false, because they are trying to be descriptive beliefs, and judged by the standards of descriptive mental models, they are not true. This is an _error theory_ of morality. [@mackie_ethics_1977]
...
A third interpretation of statements about moral constructs is that they are not to be taken literally, but are _useful fictions,_ like a fable, intended to remind individuals to act in accord with some moral system. However, this is a dubious interpretation, since it requires everyone speaking, listening, writing, and reading about moral constructs to be consciously aware that moral constructs do not actually exist and to be engaged in some sort of prolonged irony. This interpretation is included here only for the sake of completeness. It is not recommended because it is prone to delusions that moral constructs refer to something in the non-mental world.
