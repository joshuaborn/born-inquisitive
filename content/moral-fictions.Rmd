...
output:
  blogdown::html_page:
    ...
    toc_depth: 5
include-before: |
  <p>Much of moral philosophy would construe morality as a search for truths and moral knowledge, and much of everyday moralizing consists of hand-wringing over constructs such as "justice" or "human rights." This article disabuses morality of these delusions by examining differences between descriptive and normative mental models, leading to implications that truth and falsity apply to the former, but not the latter, which in turn implies practices for dealing with moral sentiments. Finally, several interpretations of moral constructs are considered which have in common the judgement that moral constructs are fictions.</p>
  <!--more-->
---
