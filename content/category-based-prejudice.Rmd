...
output:
  blogdown::html_page:
    ...
    toc: true
    toc_depth: 5
summary: 'Properties of a population are not properties of individuals, and categorization is arbitrary. Therefore, category-based prejudice is more costly, less accurate, and more ambiguous than direct measurement.'
tags: ["opinion", "fallacies", "third-person"]
...
](/images/dictionary.jpg){alt="Close-up of an entry in an English dictionary."}
...
```{r shapes-figure, cache=FALSE, dependson="font-setup", fig.height=7, fig.width=7, fig.cap="Geometric figures of various colors, sizes, and shapes, laid out on a two-dimensional plane."}
y_limit <- 10
x_limit <- 10
side_max <- 1
side_min <- 0.25
...
and is not modified.
](/images/average-person.jpg){alt="The Lord Warden pub in Liverpool, England with the message \"The average person thinks they're more intelligent than average. Do you think you are more intelligent than the average person?\" stenciled on the side."}
...
and is not modified.
](/images/interview-woman.jpg){alt="A woman being interviewed for a job from a perspective over the shoulder of the interviewer."}
...
[CC BY-SA 2.0](https://creativecommons.org/licenses/by-sa/2.0/)
and is not modified.
](/images/interview-man.jpg){alt="A man being interviewed for a job by the same interviewer as in the previous image."}
...
](/images/math-test.jpg){alt="A close-up of a answer sheet from a math test, with several sketches and equations written in pencil."}
...
and is not modified.
](/images/university-students.jpg){alt="Four university students sitting and chatting while on campus."}
...
[CC BY-SA 2.0](https://creativecommons.org/licenses/by-sa/2.0/)
and is not modified.
](/images/interview-woman-2.jpg){alt="An Asian woman sitting at a table being interviewed for a job."}
...
[^stereotypes]: Curiously, the authors report that the stereotype that Asians are good at math was more prevalent in the United States than in Canada based on a poll they did of random samples of people in Vancouver, British Columbia and in Cambridge, Massachusetts, but did not report just how prevalent the stereotype was in either place. (Why this is a bad practice is discussed extensively in the article on how to [scrutinize a statistic](/how-to-scrutinize-a-statistic.html). Indeed, it is used as an example [in one section](/how-to-scrutinize-a-statistic.html#not-sharing-effect-size) of said article.)
...
and is not modified.
](/images/pedigree.jpg){alt="A screenshot of a pedigree being assembled in a genealogy computer program."}
