...
```{r font-setup, cache=TRUE}
font_add_google('Open Sans', 'open')
#font_add_google('Sorts Mill Goudy', 'sortsmill')
...
```{r shapes-figure, cache=TRUE, dependson="font-setup", fig.height=7, fig.width=7, fig.cap="Geometric figures of various colors, sizes, and shapes, laid out on a two-dimensional plane."}
y_limit <- 10
x_limit <- 10
side_max <- 1
side_min <- 0.25
