...
generate_obj <- function() {
  ...
  if (shape == 'circle') {
    side <- side_min + rbeta(1, 2, 2) / 4 + sample(c(0, 0.5), 1)
  } else {
...
![
A page from a math test being completed by pencil.<br/>
...
_**create an example histogram here**_
