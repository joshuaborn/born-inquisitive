...
Before the particular flaws of category-based prejudice are examined, two larger principles about categories are illustrated by way of a more abstract example. These larger principles are

1. Properties of populations are not properties of individuals.
2. Categorization is arbitrary.

```{r, shapes-figure, cache=TRUE, fig.height=7, fig.width=7}
y_limit <- 10
x_limit <- 10
square_max <- 1
square_min <- 0.25
