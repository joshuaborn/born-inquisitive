...
output:
  blogdown::html_page:
    ...
    toc_depth: 5
include-before: |
  <p>In this article, I reflect how partisan demagoguery has afflicted my thinking in the past, despite being alienated from the partisan factions around me. I note how characterizations of "they," "them," or "those people" lead to the straw man fallacy and a kind of no true Scotsman fallacy, but perhaps more importantly, how such characterizations further empower polarized factions at the expense of independent thinkers. Therefore, I resolve to avoid partisan demagoguery in the future.</p>
  <!--more-->
  ## Table of Contents
---
...
[^converse]: Note that the _reductio ad Hitlerum_ fallacy is not applicable to criticisms of warmongering or racial bigotry. These are things that most of us judge to be bad and therefore judge Hitler to be bad _because_ he did these things. Indeed, warmongering and racial bigotry would still be judged to be bad regardless of whether Hitler did them. The _reductio ad Hitlerum_ fallacy reverses this implication by attempting to infer that some things are bad because Hitler did them.
...
Partisan demagoguery is like that tar wolf. The more you let it anger you and the more you lash out at it, the more caught by it you become. Such is polarization. Had the rabbit simply walked past the tar wolf, it could have had its fill of water from the well and gone on with its life unmolested. The only way to avoid the trap of fallacies created by partisan polarization is to be a better person and metaphorically walk past it.
