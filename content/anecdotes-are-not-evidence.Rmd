...
output:
  blogdown::html_page:
    ...
    toc: true
    toc_depth: 5
summary: "Anecdotal evidence has flaws that make it useless for inferences about populations or about cause and effect. Valid uses of anecdotes exist, but anecdotes should be scrutinized even in such cases."
tags: ["opinion", "fallacies", "statistics", "psychology", "third-person"]
...
and is not modified.
](/images/rush-hour.jpg){alt="Bumper-to-bumper cars on a highway with brake lights visible."}
...
and is not modified.
](/images/clinical-trial.jpg){alt="An African man wearing a lab coat and looking through a microscope."}
...
](/images/summer-of-the-shark.jpg){alt="Time magazine cover prominently displaying a shark in turbulent water with its head peeking above the surface and its mouth open."}
...
](/images/video-camera.jpg){alt="A close-up of a video camera at an event, with camera in focus and the background blurred."}
...
](/images/broken-glass.jpg){alt="Shards of glass of various sizes lying on a sidewalk."}
...
](/images/barn.jpg){alt="A wood barn with a red roof in the countryside next to a small gravel and dirt road."}
...
](/images/telephone-game.jpg){alt="Four children in a classroom, with one child whispering into the ear of another."}
...
](/images/bicycle-theft.jpg){alt="A bike rack attached to a brick wall, with a bicycle wheel fastened to the bike rack with a chain lock."}
...
](/images/black-swan.jpg){alt="A swan with a red beak and black weathers floating water."}
