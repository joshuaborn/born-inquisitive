...
The results of this and other similar experiments were germane because the 1990s introduced criminal prosecutions based on individuals allegedly recalling repressed memories of childhood abuse, memories that were only discovered after extensive therapy sessions. As was seen in the experiment, a nontrivial number of test subjects incorrectly believed the event that never happened was true, and after discussing this false event during the first interview, certainty in it appeared to be increasing. Thus, the issue with the cases built on allegedly repressed memories was that some may have been false memories inculcated by therapists inadvertently using methods similar to the experiment. [@loftus_reality_1993]

##### Word Lists

While the research of Elizabeth Loftus and others would have direct implications for the courtroom, this line of research focused on memories affected by misinformation encountered _after_ the original experience. [@loftus_planting_2005] Other lines of research explored false recall of memories not tainted in this way.
...
What caused the overall worse performance of serial reproduction over repeated reproduction in this experiment was that each step in serial reproduction carried over the mistakes from the previous steps. Once a word that really did appear on the original DRM world list was forgotten, it would not appear on the input list for subsequent serial steps and thus be lost for the rest of the process. Once a nonpresented word was falsely recalled, it would be put on the input list for the subsequent serial step and so be indistinguishable from words that actually appeared on the original list.
