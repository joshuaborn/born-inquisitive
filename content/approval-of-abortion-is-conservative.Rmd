...
Sex-selective abortion could not be done in antiquity, since ultrasound or another method of reliably determining the sex of a fetus were not available. This could be done with infanticide or child abandonment, however. For instance, the Oxyrhynchus Papyri contain a letter written in Egypt during the Roman era by a gentleman by the name of Hilarion to his wife Alis:
...
Thus, there must have been some in antiquity who saw infanticide and child abandonment as preferable to induced abortion of pregnancy since it was perceived to be safer and could be used for more purposes than just fertility control, such as sex selection and disposing of children deemed unhealthy.
...
In this passage, Augustine subscribes to a basically Aristotlean view of prenatal life, such that there is a threshold _in utero_ after which killing an embryo or fetus is homicide, but before which is not.


### Quickening and Abortion in 19th Criminal Century Law

Trying to summarize views on induced abortion, contraception, and infanticide throughout the Christian era would likely require a book-length treatment and is beyond the scope of this article. However, a basically Aristotlean-Augustinian threshold-type attitude was popular enough throughout the centuries to be codified into laws of the United States.[^gump]
...
* There has been a movement away from viewing children as the property of their parents (or more specifically father) toward protection of children from being killed arbitrarily, with a trend going at least from Greek classical period all the way to the first half of the twentieth century of protecting them earlier and earlier in their development.
