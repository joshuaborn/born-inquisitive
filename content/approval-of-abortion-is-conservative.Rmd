...
For instance, each May, Gallup administers its Values and Beliefs telephone poll on a representative sample of persons in the United States aged 18 or older, as part of the ongoing Gallup Poll Social Series. This poll contains a series of questions prompted with, "I'm going to read you a list of issues. Regardless of whether or not you think it should be legal, for each one, please tell me whether you personally believe that in general it is morally acceptable, or morally wrong."

Induced abortion of pregnancy has been either the most or one of the most contentious issues in the Values and Beliefs poll ever since it began in 2001. The difference between the percent of the population judging an issue to be morally wrong and the percent of the population judging an issue to be morally acceptable can be used as a measure of how morally contentious an issue is. Very contentious issues will have a small difference, and issues for which public opinion is mostly in agreement will have large differences.

![Absolute value of differences between percent judging "morally wrong" and percent judging "morally acceptable" on three issues from the Gallup Poll Social Series, Values and Beliefs. [@gallup_how_2014] In addition to induced abortion, animal medical testing and having a baby out of wedlock are included for comparison.](/images/Gallup_contentious_moral_opinions.png){alt="A plot with the different between percent judging 'morally wrong' and percent judging 'morally acceptable' on the y-axis and year on the x-axis."}

Using this as a metric, out of the 18 topics ever asked about on the Values and Beliefs moral opinions poll, induced abortion has been the most contentious issue 11 times out of 22 times that the Value and Beliefs poll has been administered. Additionally, induced abortion has been the second most contentious issue 7 times, the third most contentious issue 2 times, and the fourth most contentious issue an additional 2 times. It has never been ranked lower than the fourth most contentious issue on the poll.
...
For the first twenty years of the Values and Beliefs poll, there appeared to be more Americans who judged induced abortion to be morally wrong than those who judged it to be morally acceptable, whereas in the past two years that trends appears to have reversed. This may or may not actually be the case. Estimates of the percent judging abortion to be wrong and the percent approving of abortion have been so close that they are likely to have been within fluctuations due to sampling error of each other. 

Furthermore, more detailed questions are needed to understand the sizable "depends on the situation" response. Indeed, given that there is much variation in public opinion on abortion depending on motives, gestational age, etc, it is likely the case that many more respondents would give a "depends on the situation" response if prompted with more than just a binary choice.

Nonetheless, if one were to suppose this apparent trend of reversal of majority opinion between morally wrong and morally acceptable is actually the case, one might be tempted to conclude that judging abortion to be morally wrong is an older, conservative viewpoint.

However, this article contends that _approval_ of abortion as a method of fertility control is a conservative viewpoint. Polls like the Gallup Poll Social Series are only slightly more than twenty years old, whereas induced abortion of pregnancy is more than two thousand years old, if not far older. In order to truly understand the social context of the moral contentiousness around induced abortion, one must understand a history of ideas spanning thousands.

Furthermore, one might believe that if polls similar to the Gallup Values and Beliefs poll do not similarly indicate that moral opinions about induced abortion are contentious in other parts of the world, then there is no moral contentiousness in these other parts of the world. For instance, induced abortion in China does not generate as much acrimony as it does in the United States. However, those who have engaged with a Chinese population in more detailed conversation about induced abortion have found diverse opinions, opinions that often touch on topics in the history of ideas summarized in this article, even if debate about induced abortion is not a prominent part of public discourse. [@nie_behind_2005]
...
There has been a trend toward protecting children from being arbitrarily killed at earlier and earlier points in their development. Western civilization began with no such protection, and instead enforced the legal right of patriarchs to choose which children to raise and which to kill as enshrined in laws such as _patria potestas._ In the late Roman Empire this became increasingly a contentious issue, until infanticide was outlawed in 374 C.E. This created the first protection of children from arbitrary killing, and established the point of protection at birth.

Later, as Aristotlean-Augustinian doctrine regarding prenatal life was codified into law in the medieval and early modern periods, this protection was extended even earlier in child development to a threshold that would come to be known in English common law as "quickening." Eventually in the 19th century, quickening was seen as pre-scientific folk belief, and with the removal of quickening criteria from criminal abortion law, the point at which children were protected from being killed arbitrarily was effectively moved all the way to their conception.

While there has been a trend toward protecting children earlier and earlier in their development, these protections have failed spectacularly. For more than a thousand years after infanticide was made illegal and as late as the 19th century, authorities struggled with what to do about mass infanticide occurring in their jurisdictions. Even as 19th century legal changes effectively criminalized induced abortion at any point during a pregnancy, hundreds of thousands if not millions of embryos and fetuses were killed just in the United States in the early 20th century.


## Conclusion

Approval of induced abortion of pregnancy as a method of fertility control is conservative because it is disposed to maintain existing conditions. Induced abortion has been advocated as a method of fertility control for more than thousand years, since at least the Greek classical period. Induced abortion is extremely common today; there are hundreds of millions of induced abortions every year. Induced abortion is the _status quo._

Furthermore, approval of induced abortion goes against a trend of protecting children earlier and earlier in their development that has slowly progressed for the past two millenia of Western civilization. If advocacy of induced abortion limits itself to advocating induced abortion before a threshold _in utero,_ then such advocacy is a return to pre-19th century thinking about prenatal life. If advocacy of induced abortion includes advocacy of induced abortion all the way up until birth, then such advocacy is a return to 4th century C.E. thinking.

In the late 20th century and early 21st century in the United States, there is a binary partisanship divided between left-wing and right-wing in which the right-wing is often labeled "conservative." Additionally, opposition to induced abortion of pregnancy is often associated with the right-wing. This might lead an indolent mind to think offhandedly that opposition to induced abortion is conservative, in the dictionary definition of the word "conservative."

As has been seen, this is not the case. It is important to remember that partisanship is not logically coherent and represents the ephemeral and arbitrary fads of the time and place in which one happens to live. What is right-wing one generation might be left-wing for another generation, and what is left-wing in one place might be right-wing in another place. Just because words such as "conservative" can be used to describe partisanship, such labels do not give true insight into historical context.
