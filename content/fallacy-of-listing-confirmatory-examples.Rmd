...
<table>
  <caption>Table 1: A 2 by 2 contingency table with information from the list of confirmatory examples.</caption>
  <thead>
    <tr class="header">
      <th></th>
      <th>Fire</th>
  ...
  <tbody>
    <tr class="odd">
      <td>With Acme Z341</td>
      <td>≥ 100</td>
      <td></td>
    </tr>
    <tr class="even">
      <td>Without Acme Z341</td>
      <td></td>
      <td></td>
    </tr>
  </tbody>
...
The body of the table contains counts of households. The columns separate these counts into households that have experienced a fire and households that have not. The rows separate the counts into households that have Acme Z341 grills and households that do not.
