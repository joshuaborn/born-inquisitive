...
Similarly, in the example of per capita expenditure on food and beverages for off-premises consumption in the United States, the response variable is numerical because a dollar amount is observed for the expenditure on food and beverages in Michigan. What made this statistic practically significance was introduction of a categorical explanatory variable with two levels: _during 2020_ or _during the previous year_. Introduction of the explanatory variable led to the statistic being recast in terms of percent increase or decrease.
...
* Numerical response and categorical explanatory
    * Difference of means
    * Standardized difference of means (Cohen's _d_)
* Categorical response and categorical explanatory
    * Difference in risk
...
* Washington Post fact checker and the Obama gender pay gap statistic gaffe
...
* Stating _p_-value instead of effect size
