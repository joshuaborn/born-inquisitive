...
The example also illustrates another phenomenon: the practical significance of a statistic comes from its comparison to something else. In the diabetes example, the statistic of the average change in blood glucose levels caused by the drug is evaluated by comparing it to the therapeutic change in blood glucose levels observed in a study. A single statistic in isolation without any contextual knowledge has no pracitical significance.

For example,

_**Talk about both observational studies and RCEs throughout this section.**_

* Practical significance often a comparison: pick a state near the middle in Bureau of Economic Analysis's personal income by state
* Response and explanatory variables
* "Effect size" but maybe use better verbiage
    * Categorical vs. numerical variables
    * Proportions
    * Means and medians
    * Correlations and model associations
    * Totals
