...
When the response variable is categorical instead of numerical, but the explanatory variable is still categorical, you are still essentially comparing the response variable between two or more populations. However, the response variable is now expressed in terms of proportions instead of means. Therefore, in this case, everything said in the previous section should be repeated, but with proportions instead of means and differences of proportions instead of differences of means.
