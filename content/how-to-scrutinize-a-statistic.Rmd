...
In these cases, you should search for both the mean response variable values reported individually and for the differences in means, because the mean values themselves can shed light on the relative magnitude of the difference.[^real-means] <!-- TO DO: Real-world example of similar differences in means, but different absolute means -->

[^real-means]: A real-world example of individual mean values illustrating relative magnitude in the difference of means will be included here in the future.
...
In cases in which an effect size is practically insignificant, the least favorable extreme of the confidence interval for the effect size will be outside of your threshold of practical significance.[^real-practically-insignificant-CI]
...
Throughout your work of scrutinizing a statistic, you should be on the look out for common fallacies, such as unadjusted confounding variables, missing denominators, unreported effect sizes, inferential statistics without inference, or _p_-hacking.

Scrutinizing statistics, though work, can also be a joy. When you are surrounded by those who want to influence rather than inform you, it is an opportunity to strengthen that most singular implement in the search for truth and knowledge: your own skeptical mind.
