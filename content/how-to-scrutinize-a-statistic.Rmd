...
* Unstandardized requires model-based analysis
* Standardized uses correlation coefficients
    * Pearson and Spearman examples for numerical response
    * Point biserial example for categorical response
    * Discuss assumptions


#### Model-based Estimation

* Single variable in original, unstandardized units
* Multiple variables
** Interactions
