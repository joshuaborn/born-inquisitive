...
```{r correlation-scatterplots, fig.width=8, fig.height=3, dpi=100, fig.cap="Scatterplots showing cases when two variables are highly correlated (left panel), not correlated (middle panel), and highly inversely correlated (right panel). Pearson correlation coefficient values are listed in the panel labels."}
n <- 100
