...
In both kinds of inference, randomization is used. This randomization introduces error into the estimates. Depending on exactly which individuals are selected for the sample, the exact values of statistics calculated from observations of the sample will be slightly different. Depending on exactly which individuals are assigned to intervention or control groups, the exact values of statistics calculated from observations in an experiment will be slightly different.

**_Possibly put some numbers to this to show how, for instance, a sample mean differs based on the exact sample taken._**
