...
* Lack of comparison: pick a state near the middle in Bureau of Economic Analysis's personal income by state
* Effect size: frame this using numerical vs. categorical variables?
    * Practical significance relative to standard deviation, but depends on subject, not statistics
    * Means and medians
    * Proportions
    * Correlations and model associations
    * Totals
* Missing denominator: maybe see what other folks have written
