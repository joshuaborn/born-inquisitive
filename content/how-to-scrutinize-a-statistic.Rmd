...
Furthermore, a lot of variables undergo trends over time and so can be falsely associated if the trends occur over the same time period. This is a phenomenon that Tyler Vigen has humorously captured in the [spurious correlations](https://tylervigen.com/spurious-correlations) section of his blog to illustrate associations between obviously unrelated variables, such as divorce rate in Maine and per capita consumption of margarine.
