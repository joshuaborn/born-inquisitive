...
include-before: |
  ## Table of Contents
summary: "Two interviews from Rationally Speaking about disagreement are reviewed: John Nerst's discussion of low resolution abstraction, and Buster Benson's learnings from arguments with friends and family."
output:
  blogdown::html_page:
    number_sections: false
    toc: true
    toc_depth: 5
tags: ["opinion", "book, article, or podcast review", "first-person"]
...
and is not modified.
](/images/light-in-the-dark.jpg){alt="A lightbulb attached to a tree illuminates the foreground while a dimly lit house in the background is barely visible behind the trees."}
...
and is not modified.
](/images/rich-and-poor.jpg){alt="A woman in nice clothes and carrying a designer handbag talks on a mobile phone while a homeless man pushes a plastic covered dolly along the same sidewalk."}
...
and is not modified.
](/images/macys.jpg){alt="The run-down facade of a Macy's department store."}
