...
output:
  blogdown::html_page:
    ...
    toc: true
    toc_depth: 5
summary: "In this article, the philosophical position of essentialism is contrasted with that of nominalism, and examples of how essentialists' assertions are frustrating to nominalists are explored."
...
To nominalism, categorizing individuals is a language convention, and [categorization is arbitrary](/category-based-prejudice.html#categorization-is-arbitrary).
...
The major implication of nominalism is that there are not correct categorizations and incorrect categorizations, but instead categorization is conventional, with some categorization schemes better than others for certain purposes and in certain contexts, but there is no one true way to categorize.
...
This can cause confusion if an essentialist interprets a nominalist's cringing as disagreement with the essentialist's answer to the question of whether someone is "really" something. The nominalist is not disagreeing with the validity of the essentialist's answer, but with the validity of the essentialist's question.
