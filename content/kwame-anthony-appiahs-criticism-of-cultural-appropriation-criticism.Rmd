...
output:
  blogdown::html_page:
    ...
    toc: true
    toc_depth: 5
summary: 'Philosopher Kwame Anthony Appiah argues that "cultural appropriation" is based on a mistaken mental model of what "culture" denotes and that there are other, better criticisms.'
tags: ["opinion", "book, article, or podcast review", "philosophy", "third-person"]
...
Toward the end of the sixth chapter of _The Lies That Bind,_ Kwame Anthony Appiah contrasts both ideas of culture with a third idea of culture that lies in the premises of allegations of "cultural appropriation." This idea is that human beings either do or do not belong to discrete groups, and that only members of a group are allowed to do certain practices associated with the group.
...
and is not modified.
](/images/kente.jpg){alt="A colorful robe is worn by a seated dummy while a similarly colorful tapestry hangs on the wall behind it."}
...
and is not modified.
](/images/sequoyah.jpg){alt="Sequoyah depicted holding a tablet with his syllabary and pointing at it."}
...
![
A man making glass in Murano, Italy, a region known for glassmaking since Renaissance times.<br/>
...
and is not modified.
](/images/murano-glass.jpg){alt="A man sits at a workbench and uses a metal tool to shape the molten glass at the end of a rod."}
...
[CC BY 2.0](https://creativecommons.org/licenses/by/2.0/)
and is not modified.
](/images/odumase-krobo-woman.jpg){alt="Several people play musical instruments and sing while sitting in the background while a woman adorned with numerous glass beads stands in the foreground."}
...
and is not modified.
](/images/kwame-anthony-appiah.jpg){alt="Kwame Anthony Appiah gesticulates with his hands while speaking."}
...
"Cultural appropriation" is to some a stinging and valid criticism. To others, the very notion seems wrong, but it is difficult to pin down why. It is [not wrong in the way that false beliefs are false](/moral-skepticism.html). It is, after all, a kind of value judgment, and value judgments are, like their subset, in the eye of the beholder.
